...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66477)].join('')));
...
var G__66509 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$$lezer$common$dist$index_cjs.NodeProp.openedBy);
if((G__66509 == null)){
return null;
} else {
return (G__66509[(0)]);
...
nextjournal.clojure_mode.node.balanced_QMARK_ = (function nextjournal$clojure_mode$node$balanced_QMARK_(p__66518){
var map__66521 = p__66518;
var map__66521__$1 = (((((!((map__66521 == null))))?(((((map__66521.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66521.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66521):map__66521);
var node = map__66521__$1;
var firstChild = (function (){var obj66527 = map__66521__$1;
if((!((obj66527 == null)))){
return (obj66527["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj66528 = map__66521__$1;
if((!((obj66528 == null)))){
return (obj66528["lastChild"]);
} else {
return undefined;
}
})();
...
var temp__5757__auto__ = (function (){var G__66542 = dir;
switch (G__66542) {
case (1):
...
return nextjournal.clojure_mode.node.children.cljs$core$IFn$_invoke$arity$3(parent,(function (){var G__66543 = dir;
switch (G__66543) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66543)].join('')));
...
var G__66548 = cljs.core.compare(nextjournal.clojure_mode.node.start(to_node),nextjournal.clojure_mode.node.start(node));
switch (G__66548) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66548)].join('')));

}
}
});
nextjournal.clojure_mode.node.nodes_between = (function nextjournal$clojure_mode$node$nodes_between(node,to_node){
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.iterate((function (p1__66549_SHARP_){
return nextjournal.clojure_mode.node.move_toward(p1__66549_SHARP_,to_node);
}),node));
});
...
var or__4253__auto__ = nextjournal.clojure_mode.node.highest(node,(function (p1__66570_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(from,nextjournal.clojure_mode.node.start(p1__66570_SHARP_));
}));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var vec__66579 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from,to], null));
var from__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66579,(0),null);
var to__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66579,(1),null);
...
var vec__66582 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__66585,node_between){
var vec__66587 = p__66585;
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66587,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66587,(1),null);
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from__$2,to__$2], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66575_SHARP_){
var G__66592 = p1__66575_SHARP_;
if(nextjournal.clojure_mode.node.edge_QMARK_(p1__66575_SHARP_)){
return nextjournal.clojure_mode.node.up(G__66592);
} else {
return G__66592;
}
}),nextjournal.clojure_mode.node.nodes_between(from_node,to_node)));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66582,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66582,(1),null);
 ...
 */
nextjournal.clojure_mode.node.inner_span = (function nextjournal$clojure_mode$node$inner_span(p__66594){
var map__66599 = p__66594;
...
var node = map__66599__$1;
var firstChild = (function (){var obj66601 = map__66599__$1;
if((!((obj66601 == null)))){
return (obj66601["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj66602 = map__66599__$1;
if((!((obj66602 == null)))){
return (obj66602["lastChild"]);
} else {
return undefined;
}
})();
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__66609 = nextjournal.clojure_mode.node.prefix(node);
if((G__66609 == null)){
return null;
} else {
return nextjournal.clojure_mode.node.string.cljs$core$IFn$_invoke$arity$2(state,G__66609);
}
...
return nextjournal.clojure_mode.node.up(G__66610);
} else {
return G__66610;
}
});
...
var G__66614 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__66614 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__66614,(function (p1__66613_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.end(p1__66613_SHARP_));
}));
}
});
/**
...
var G__66617 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__66617 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__66617,(function (p1__66616_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.start(p1__66616_SHARP_));
}));
}
});
nextjournal.clojure_mode.node.nearest_touching = (function nextjournal$clojure_mode$node$nearest_touching(state,pos,dir){
var L = (function (){var G__66620 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__66620 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__66620,(function (p__66621){
var map__66622 = p__66621;
var map__66622__$1 = (((((!((map__66622 == null))))?(((((map__66622.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66622.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66622):map__66622);
var to = (function (){var obj66624 = map__66622__$1;
if((!((obj66624 == null)))){
return (obj66624["to"]);
} else {
return undefined;
...
var R = (function (){var G__66625 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__66625 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__66625,(function (p__66626){
...
var from = (function (){var obj66629 = map__66627__$1;
if((!((obj66629 == null)))){
return (obj66629["from"]);
} else {
return undefined;
}
})();
...
switch (G__66630) {
case (1):
var or__4253__auto__ = nextjournal.clojure_mode.util.guard(R,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__66618_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__66618_SHARP_)) || ((!(nextjournal.clojure_mode.node.right_edge_QMARK_(p1__66618_SHARP_)))));
})));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
break;
case (-1):
var or__4253__auto__ = nextjournal.clojure_mode.util.guard(L,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__66619_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__66619_SHARP_)) || ((!(nextjournal.clojure_mode.node.left_edge_QMARK_(p1__66619_SHARP_)))));
})));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66630)].join('')));
