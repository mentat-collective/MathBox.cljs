...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53038)].join('')));
...
var G__53041 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$$lezer$common$dist$index_cjs.NodeProp.closedBy);
if((G__53041 == null)){
return null;
} else {
return (G__53041[(0)]);
...
var G__53042 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$$lezer$common$dist$index_cjs.NodeProp.openedBy);
if((G__53042 == null)){
return null;
} else {
return (G__53042[(0)]);
...
nextjournal.clojure_mode.node.balanced_QMARK_ = (function nextjournal$clojure_mode$node$balanced_QMARK_(p__53043){
var map__53044 = p__53043;
...
var node = map__53044__$1;
var firstChild = (function (){var obj53049 = map__53044__$1;
if((!((obj53049 == null)))){
return (obj53049["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj53050 = map__53044__$1;
if((!((obj53050 == null)))){
return (obj53050["lastChild"]);
} else {
return undefined;
}
})();
...
var temp__5808__auto__ = (function (){var G__53056 = dir;
switch (G__53056) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53056)].join('')));
...
return nextjournal.clojure_mode.node.children.cljs$core$IFn$_invoke$arity$3(parent,(function (){var G__53057 = dir;
switch (G__53057) {
case (1):
...
var G__53071 = cljs.core.compare(nextjournal.clojure_mode.node.start(to_node),nextjournal.clojure_mode.node.start(node));
switch (G__53071) {
case (0):
...
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.iterate((function (p1__53072_SHARP_){
return nextjournal.clojure_mode.node.move_toward(p1__53072_SHARP_,to_node);
}),node));
});
...
var or__5045__auto__ = nextjournal.clojure_mode.node.highest(node,(function (p1__53084_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(from,nextjournal.clojure_mode.node.start(p1__53084_SHARP_));
}));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var vec__53098 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from,to], null));
var from__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53098,(0),null);
var to__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53098,(1),null);
...
var vec__53101 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__53104,node_between){
var vec__53105 = p__53104;
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53105,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53105,(1),null);
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from__$2,to__$2], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53088_SHARP_){
var G__53108 = p1__53088_SHARP_;
if(nextjournal.clojure_mode.node.edge_QMARK_(p1__53088_SHARP_)){
return nextjournal.clojure_mode.node.up(G__53108);
} else {
return G__53108;
}
}),nextjournal.clojure_mode.node.nodes_between(from_node,to_node)));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53101,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53101,(1),null);
 ...
 */
nextjournal.clojure_mode.node.inner_span = (function nextjournal$clojure_mode$node$inner_span(p__53109){
...
var node = map__53111__$1;
var firstChild = (function (){var obj53113 = map__53111__$1;
if((!((obj53113 == null)))){
return (obj53113["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj53114 = map__53111__$1;
if((!((obj53114 == null)))){
return (obj53114["lastChild"]);
} else {
return undefined;
}
})();
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__53116 = nextjournal.clojure_mode.node.prefix(node);
if((G__53116 == null)){
return null;
} else {
return nextjournal.clojure_mode.node.string.cljs$core$IFn$_invoke$arity$2(state,G__53116);
}
...
return nextjournal.clojure_mode.node.up(G__53117);
} else {
return G__53117;
}
});
...
var G__53119 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__53119 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__53119,(function (p1__53118_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.end(p1__53118_SHARP_));
}));
}
});
/**
...
var G__53121 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__53121 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__53121,(function (p1__53120_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.start(p1__53120_SHARP_));
}));
}
});
nextjournal.clojure_mode.node.nearest_touching = (function nextjournal$clojure_mode$node$nearest_touching(state,pos,dir){
var L = (function (){var G__53124 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__53124 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__53124,(function (p__53125){
...
var to = (function (){var obj53130 = map__53126__$1;
if((!((obj53130 == null)))){
return (obj53130["to"]);
} else {
return undefined;
...
var R = (function (){var G__53131 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__53131 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__53131,(function (p__53132){
...
var from = (function (){var obj53139 = map__53133__$1;
if((!((obj53139 == null)))){
return (obj53139["from"]);
} else {
return undefined;
}
})();
...
switch (G__53140) {
case (1):
var or__5045__auto__ = nextjournal.clojure_mode.util.guard(R,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__53122_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__53122_SHARP_)) || ((!(nextjournal.clojure_mode.node.right_edge_QMARK_(p1__53122_SHARP_)))));
})));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
break;
case (-1):
var or__5045__auto__ = nextjournal.clojure_mode.util.guard(L,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__53123_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__53123_SHARP_)) || ((!(nextjournal.clojure_mode.node.left_edge_QMARK_(p1__53123_SHARP_)))));
})));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53140)].join('')));
