...
var map__67373 = cljs.core.meta(iobj);
var map__67373__$1 = cljs.core.__destructure_map(map__67373);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67373__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67373__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__67373__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__67384 = (function (){var or__4253__auto__ = stack;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__67385 = env;
var G__67385__$1 = (((G__67385 == null))?null:cljs.core.deref(G__67385));
var G__67385__$2 = (((G__67385__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__67385__$1));
var G__67385__$3 = (((G__67385__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__67385__$2,id));
var G__67385__$4 = (((G__67385__$3 == null))?null:cljs.core.deref(G__67385__$3));
var G__67385__$5 = (((G__67385__$4 == null))?null:cljs.core.last(G__67385__$4));
if((G__67385__$5 == null)){
return null;
} else {
return cljs.core.meta(G__67385__$5);
}
}
})();
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67384__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var len__4864__auto___67455 = arguments.length;
var i__4865__auto___67456 = (0);
while(true){
if((i__4865__auto___67456 < len__4864__auto___67455)){
args__4870__auto__.push((arguments[i__4865__auto___67456]));

var G__67458 = (i__4865__auto___67456 + (1));
i__4865__auto___67456 = G__67458;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq67390){
var G__67391 = cljs.core.first(seq67390);
var seq67390__$1 = cljs.core.next(seq67390);
var G__67392 = cljs.core.first(seq67390__$1);
var seq67390__$2 = cljs.core.next(seq67390__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67391,G__67392,seq67390__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__67399 = cljs.core.namespace(sym);
switch (G__67399) {
case "clojure.core":
case "cljs.core":
...
var fexpr__67402 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__67402.cljs$core$IFn$_invoke$arity$2 ? fexpr__67402.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__67402.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__67403_SHARP_){
return f(p1__67403_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__67406 = pred;
var G__67408 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__67406,G__67408) : sci.impl.utils.split_when.call(null,G__67406,G__67408));
})());
} else {
return null;
}
...
var G__67469 = cljs.core.next(params__$1);
var G__67470 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__67471 = lets;
params__$1 = G__67469;
new_params = G__67470;
lets = G__67471;
...
var G__67472 = cljs.core.next(params__$1);
var G__67473 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__67474 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__67472;
new_params = G__67473;
lets = G__67474;
continue;
...
var G__67421 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67421,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__67421;
}
}));
...
var args__4870__auto__ = [];
var len__4864__auto___67481 = arguments.length;
var i__4865__auto___67482 = (0);
while(true){
if((i__4865__auto___67482 < len__4864__auto___67481)){
args__4870__auto__.push((arguments[i__4865__auto___67482]));

var G__67483 = (i__4865__auto___67482 + (1));
i__4865__auto___67482 = G__67483;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq67422){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq67422));
}));
...
var G__67430 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__67430);
