...
var map__56392 = cljs.core.meta(iobj);
var map__56392__$1 = cljs.core.__destructure_map(map__56392);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56392__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56392__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56392__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__56400 = (function (){var or__5045__auto__ = stack;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var G__56401 = env;
var G__56401__$1 = (((G__56401 == null))?null:cljs.core.deref(G__56401));
var G__56401__$2 = (((G__56401__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__56401__$1));
var G__56401__$3 = (((G__56401__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__56401__$2,id));
var G__56401__$4 = (((G__56401__$3 == null))?null:cljs.core.deref(G__56401__$3));
var G__56401__$5 = (((G__56401__$4 == null))?null:cljs.core.last(G__56401__$4));
if((G__56401__$5 == null)){
return null;
} else {
return cljs.core.meta(G__56401__$5);
}
}
})();
var map__56400__$1 = cljs.core.__destructure_map(map__56400);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56400__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56400__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56400__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__56404 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56404,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__56404;
}
})();
...
var len__5769__auto___56510 = arguments.length;
var i__5770__auto___56511 = (0);
while(true){
if((i__5770__auto___56511 < len__5769__auto___56510)){
args__5775__auto__.push((arguments[i__5770__auto___56511]));

var G__56512 = (i__5770__auto___56511 + (1));
i__5770__auto___56511 = G__56512;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq56409){
var G__56410 = cljs.core.first(seq56409);
var seq56409__$1 = cljs.core.next(seq56409);
var G__56411 = cljs.core.first(seq56409__$1);
var seq56409__$2 = cljs.core.next(seq56409__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56410,G__56411,seq56409__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__56419 = cljs.core.namespace(sym);
switch (G__56419) {
case "clojure.core":
case "cljs.core":
...
var fexpr__56427 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__56427.cljs$core$IFn$_invoke$arity$2 ? fexpr__56427.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__56427.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__56428_SHARP_){
return f(p1__56428_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__56431 = pred;
var G__56432 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__56431,G__56432) : sci.impl.utils.split_when.call(null,G__56431,G__56432));
})());
} else {
return null;
}
...
var G__56524 = cljs.core.next(params__$1);
var G__56525 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__56526 = lets;
params__$1 = G__56524;
new_params = G__56525;
lets = G__56526;
...
var G__56527 = cljs.core.next(params__$1);
var G__56528 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__56529 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__56527;
new_params = G__56528;
lets = G__56529;
continue;
...
var G__56451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56451,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__56451;
}
}));
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq56452){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56452));
}));
...
var G__56460 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__56460);
