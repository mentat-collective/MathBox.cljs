...
var G__41901 = devtools.prefs.pref(v);
v = G__41901;
continue;
} else {
return v;
...
}catch (e41799){var _e__40311__auto__ = e41799;
return false;
}})();
...
}catch (e41808){var _e__40311__auto__ = e41808;
return false;
}})();
...
}catch (e41816){var _e__40311__auto__ = e41816;
return false;
}}
}
});
...
var vec__41856 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41856,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41856,(1),null);
...
return cljs.core.some((function (p1__41874_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41874_SHARP_);
}),template);
});
