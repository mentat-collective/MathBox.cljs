...
var len__5769__auto___64440 = arguments.length;
var i__5770__auto___64441 = (0);
while(true){
if((i__5770__auto___64441 < len__5769__auto___64440)){
args__5775__auto__.push((arguments[i__5770__auto___64441]));

var G__64442 = (i__5770__auto___64441 + (1));
i__5770__auto___64441 = G__64442;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__64434){
var vec__64435 = p__64434;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64435,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__64425_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__64425_SHARP_) : allowed_QMARK_.call(null,p1__64425_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__64425_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq64426){
var G__64427 = cljs.core.first(seq64426);
var seq64426__$1 = cljs.core.next(seq64426);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64427,seq64426__$1);
}));
