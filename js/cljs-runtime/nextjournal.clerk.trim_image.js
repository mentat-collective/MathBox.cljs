...
var G__64529 = (cljs.core.truth_(from_top_QMARK_)?(y + (1)):(y - (1)));
var G__64530 = (function (){var x = (0);
while(true){
...
var G__64532 = (cljs.core.truth_(from_left_QMARK_)?(x + (1)):(x - (1)));
var G__64533 = (function (){var y = (0);
while(true){
if((!(nextjournal.clerk.trim_image.white_QMARK_(x,y,img_width,img_data)))){
return x;
} else {
...
(nextjournal.clerk.trim_image.trim_image.cljs$core$IFn$_invoke$arity$2 = (function (img,p__64515){
var map__64516 = p__64515;
var map__64516__$1 = cljs.core.__destructure_map(map__64516);
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64516__$1,new cljs.core.Keyword(null,"padding","padding",1660304693),(0));
