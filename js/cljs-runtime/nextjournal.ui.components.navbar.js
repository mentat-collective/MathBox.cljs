...
var map__54679 = cljs.core.deref(_BANG_state);
var map__54679__$1 = cljs.core.__destructure_map(map__54679);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54679__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var scroll_animation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54679__$1,new cljs.core.Keyword(null,"scroll-animation","scroll-animation",2033576100));
var scroll_el = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54679__$1,new cljs.core.Keyword(null,"scroll-el","scroll-el",2005954473));
var visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54679__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715));
...
var len__4864__auto___54878 = arguments.length;
var i__4865__auto___54879 = (0);
while(true){
if((i__4865__auto___54879 < len__4864__auto___54878)){
args__4870__auto__.push((arguments[i__4865__auto___54879]));

var G__54880 = (i__4865__auto___54879 + (1));
i__4865__auto___54879 = G__54880;
continue;
} else {
}
break;
...
(nextjournal.ui.components.navbar.toc_items.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,items,p__54687){
var vec__54688 = p__54687;
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54688,(0),null);
var map__54691 = cljs.core.deref(_BANG_state);
var map__54691__$1 = cljs.core.__destructure_map(map__54691);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54691__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54692){
var map__54693 = p__54692;
var map__54693__$1 = cljs.core.__destructure_map(map__54693);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54693__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54693__$1,new cljs.core.Keyword(null,"title","title",636505583));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54693__$1,new cljs.core.Keyword(null,"items","items",1031954938));
...
/** @this {Function} */
(nextjournal.ui.components.navbar.toc_items.cljs$lang$applyTo = (function (seq54684){
var G__54685 = cljs.core.first(seq54684);
var seq54684__$1 = cljs.core.next(seq54684);
var G__54686 = cljs.core.first(seq54684__$1);
var seq54684__$2 = cljs.core.next(seq54684__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54685,G__54686,seq54684__$2);
}));
...
var map__54695 = cljs.core.deref(_BANG_state);
var map__54695__$1 = cljs.core.__destructure_map(map__54695);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54695__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54695__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__54696){
var map__54697 = p__54696;
var map__54697__$1 = cljs.core.__destructure_map(map__54697);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54697__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54697__$1,new cljs.core.Keyword(null,"title","title",636505583));
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54697__$1,new cljs.core.Keyword(null,"expanded?","expanded?",2055832296));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54697__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54697__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54697__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
setTimeout((function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_BANG_state,(function (p1__54694_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc_in(p1__54694_SHARP_,cljs.core.vec(cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(update_at,i,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"loading?","loading?",1905707049)], 0))),false),new cljs.core.Keyword(null,"toc","toc",2050089251),toc);
}));
}),(500));
} else {
}
...
var map__54714 = cljs.core.deref(_BANG_state);
var map__54714__$1 = cljs.core.__destructure_map(map__54714);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54714__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54714__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54714__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
var args__4870__auto__ = [];
var len__4864__auto___54893 = arguments.length;
var i__4865__auto___54894 = (0);
while(true){
if((i__4865__auto___54894 < len__4864__auto___54893)){
args__4870__auto__.push((arguments[i__4865__auto___54894]));

var G__54896 = (i__4865__auto___54894 + (1));
i__4865__auto___54894 = G__54896;
continue;
} else {
}
break;
...
(nextjournal.ui.components.navbar.toggle_button.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,content,p__54741){
var vec__54742 = p__54741;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54742,(0),null);
var map__54747 = cljs.core.deref(_BANG_state);
var map__54747__$1 = cljs.core.__destructure_map(map__54747);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54747__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54747__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54747__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
/** @this {Function} */
(nextjournal.ui.components.navbar.toggle_button.cljs$lang$applyTo = (function (seq54732){
var G__54733 = cljs.core.first(seq54732);
var seq54732__$1 = cljs.core.next(seq54732);
var G__54734 = cljs.core.first(seq54732__$1);
var seq54732__$2 = cljs.core.next(seq54732__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54733,G__54734,seq54732__$2);
}));

nextjournal.ui.components.navbar.panel = (function nextjournal$ui$components$navbar$panel(_BANG_state,content){
var with_let54771 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let54771","with-let54771",-212438275));
var temp__5757__auto___54900 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___54900 == null)){
} else {
var c__51398__auto___54902 = temp__5757__auto___54900;
if((with_let54771.generation === c__51398__auto___54902.ratomGeneration)){
...
(with_let54771.generation = c__51398__auto___54902.ratomGeneration);
}

var init54772 = (with_let54771.length === (0));
var map__54780 = ((((init54772) || (cljs.core.not(with_let54771.hasOwnProperty((0))))))?(with_let54771[(0)] = cljs.core.deref(_BANG_state)):(with_let54771[(0)]));
var map__54780__$1 = cljs.core.__destructure_map(map__54780);
var local_storage_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54780__$1,new cljs.core.Keyword(null,"local-storage-key","local-storage-key",-1983909558));
var component_key = ((((init54772) || (cljs.core.not(with_let54771.hasOwnProperty((1))))))?(with_let54771[(1)] = (function (){var or__4253__auto__ = local_storage_key;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var resize = ((((init54772) || (cljs.core.not(with_let54771.hasOwnProperty((2))))))?(with_let54771[(2)] = (function (){
...
var ref_fn = ((((init54772) || (cljs.core.not(with_let54771.hasOwnProperty((3))))))?(with_let54771[(3)] = (function (p1__54765_SHARP_){
if(cljs.core.truth_(p1__54765_SHARP_)){
if(cljs.core.truth_(local_storage_key)){
cljs.core.add_watch(_BANG_state,new cljs.core.Keyword("nextjournal.ui.components.navbar","persist","nextjournal.ui.components.navbar/persist",311826868),(function (_,___$1,old,p__54788){
var map__54789 = p__54788;
var map__54789__$1 = cljs.core.__destructure_map(map__54789);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54789__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
var spring = ((((init54772) || (cljs.core.not(with_let54771.hasOwnProperty((4))))))?(with_let54771[(4)] = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"spring","spring",787848305),new cljs.core.Keyword(null,"duration","duration",1444101068),0.35,new cljs.core.Keyword(null,"bounce","bounce",1491727280),0.1], null)):(with_let54771[(4)]));
var res54773 = (function (){var map__54799 = cljs.core.deref(_BANG_state);
var map__54799__$1 = cljs.core.__destructure_map(map__54799);
var animating_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"animating?","animating?",-333605094));
var hide_toggle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"hide-toggle?","hide-toggle?",-1874012773));
var animation_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"animation-mode","animation-mode",245298782));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var mobile_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"mobile-width","mobile-width",-48320880));
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54799__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
var with_let54834 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let54834","with-let54834",602599323));
var temp__5757__auto___54917 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___54917 == null)){
} else {
var c__51398__auto___54918 = temp__5757__auto___54917;
if((with_let54834.generation === c__51398__auto___54918.ratomGeneration)){
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).error(["Warning: The same with-let is being used more ","than once in the same reactive context."].join(''));
} else {
}
