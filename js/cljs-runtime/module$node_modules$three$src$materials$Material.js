...
this.wireframe);1<this.wireframeLinewidth&&(data$jscomp$0.wireframeLinewidth=this.wireframeLinewidth);"round"!==this.wireframeLinecap&&(data$jscomp$0.wireframeLinecap=this.wireframeLinecap);"round"!==this.wireframeLinejoin&&(data$jscomp$0.wireframeLinejoin=this.wireframeLinejoin);!0===this.flatShading&&(data$jscomp$0.flatShading=this.flatShading);!1===this.visible&&(data$jscomp$0.visible=!1);!1===this.toneMapped&&(data$jscomp$0.toneMapped=!1);!1===this.fog&&(data$jscomp$0.fog=!1);0<Object.keys(this.userData).length&&
