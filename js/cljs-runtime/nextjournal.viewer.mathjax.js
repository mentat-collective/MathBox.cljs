...
var with_let67023 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let67023","with-let67023",-1072039716));
var temp__5757__auto___67031 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___67031 == null)){
} else {
var c__62648__auto___67032 = temp__5757__auto___67031;
if((with_let67023.generation === c__62648__auto___67032.ratomGeneration)){
...
(with_let67023.generation = c__62648__auto___67032.ratomGeneration);
}

var init67024 = (with_let67023.length === (0));
var _BANG_el = ((((init67024) || (cljs.core.not(with_let67023.hasOwnProperty((0))))))?(with_let67023[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let67023[(0)]));
var _BANG_mathjax = ((((init67024) || (cljs.core.not(with_let67023.hasOwnProperty((1))))))?(with_let67023[(1)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let67023[(1)]));
var res67025 = (function (){
var obj__60830__auto___67033 = module$node_modules$d3_require$dist$d3_require.require((nextjournal.viewer.mathjax.bundle_url.cljs$core$IFn$_invoke$arity$1 ? nextjournal.viewer.mathjax.bundle_url.cljs$core$IFn$_invoke$arity$1(nextjournal.viewer.mathjax.output_format) : nextjournal.viewer.mathjax.bundle_url.call(null,nextjournal.viewer.mathjax.output_format)));
var f__60831__auto___67034 = (obj__60830__auto___67033["then"]);
f__60831__auto___67034.call(obj__60830__auto___67033,(function (){
...
var r_67036 = (function (){var G__67026 = nextjournal.viewer.mathjax.output_format;
var G__67026__$1 = (((G__67026 instanceof cljs.core.Keyword))?G__67026.fqn:null);
switch (G__67026__$1) {
case "svg":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__67026__$1)].join('')));

}
})();
var temp__5751__auto___67038 = cljs.core.deref(_BANG_el).firstChild;
if(cljs.core.truth_(temp__5751__auto___67038)){
var c_67040 = temp__5751__auto___67038;
cljs.core.deref(_BANG_el).replaceChild(r_67036,c_67040);
} else {
