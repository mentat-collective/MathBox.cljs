...
var with_let55966 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let55966","with-let55966",-2033923854));
var temp__5808__auto___56029 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___56029 == null)){
} else {
var c__53026__auto___56033 = temp__5808__auto___56029;
if((with_let55966.generation === c__53026__auto___56033.ratomGeneration)){
...
(with_let55966.generation = c__53026__auto___56033.ratomGeneration);
}

var init55967 = (with_let55966.length === (0));
var _BANG_el = ((((init55967) || (cljs.core.not(with_let55966.hasOwnProperty((0))))))?(with_let55966[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let55966[(0)]));
var _BANG_mathjax = ((((init55967) || (cljs.core.not(with_let55966.hasOwnProperty((1))))))?(with_let55966[(1)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let55966[(1)]));
var res55968 = (function (){
var obj__50959__auto___56036 = module$node_modules$d3_require$dist$d3_require.require((nextjournal.viewer.mathjax.bundle_url.cljs$core$IFn$_invoke$arity$1 ? nextjournal.viewer.mathjax.bundle_url.cljs$core$IFn$_invoke$arity$1(nextjournal.viewer.mathjax.output_format) : nextjournal.viewer.mathjax.bundle_url.call(null,nextjournal.viewer.mathjax.output_format)));
var f__50960__auto___56037 = (obj__50959__auto___56036["then"]);
f__50960__auto___56037.call(obj__50959__auto___56036,(function (){
...
var r_56041 = (function (){var G__56019 = nextjournal.viewer.mathjax.output_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56019__$1)].join('')));

}
})();
var temp__5802__auto___56043 = cljs.core.deref(_BANG_el).firstChild;
if(cljs.core.truth_(temp__5802__auto___56043)){
var c_56044 = temp__5802__auto___56043;
cljs.core.deref(_BANG_el).replaceChild(r_56041,c_56044);
} else {
cljs.core.deref(_BANG_el).appendChild(r_56041);
}
} else {
}
