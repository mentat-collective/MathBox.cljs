...
var G__54034 = o;
reagent.impl.template.goog$module$goog$object.set(G__54034,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__54153__delegate = function (args){
...
while (G__54154__i < G__54154__a.length) {G__54154__a[G__54154__i] = arguments[G__54154__i + 0]; ++G__54154__i;}
  args = new cljs.core.IndexedSeq(G__54154__a,0,null);
} 
return G__54153__delegate.call(this,args);};
...
return G__54153__delegate(args);
});
...
var G__54048 = o;
reagent.impl.template.goog$module$goog$object.set(G__54048,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__54156__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54156 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54157__i = 0, G__54157__a = new Array(arguments.length -  0);
while (G__54157__i < G__54157__a.length) {G__54157__a[G__54157__i] = arguments[G__54157__i + 0]; ++G__54157__i;}
  args = new cljs.core.IndexedSeq(G__54157__a,0,null);
} 
return G__54156__delegate.call(this,args);};
G__54156.cljs$lang$maxFixedArity = 0;
G__54156.cljs$lang$applyTo = (function (arglist__54158){
var args = cljs.core.seq(arglist__54158);
return G__54156__delegate(args);
});
...
var G__54080 = props;
var G__54080__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54080,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__54080);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54080__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__54081 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54081,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__54081;
}
})(),id_class);
...
var G__54083 = (cljs.core.count(argv) - first_child);
switch (G__54083) {
case (0):
...
var vec__54086 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54086,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54086,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54086,(2),null);
...
var temp__5808__auto___54160 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___54160 == null)){
} else {
var key_54161 = temp__5808__auto___54160;
(jsprops.key = key_54161);
}
...
var temp__5808__auto___54162 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___54162 == null)){
} else {
var key_54163 = temp__5808__auto___54162;
(jsprops.key = key_54163);
}
...
var temp__5808__auto___54164 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___54164 == null)){
} else {
var key_54165 = temp__5808__auto___54164;
(jsprops.key = key_54165);
}
...
var temp__5808__auto___54166 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___54166 == null)){
} else {
var key_54167 = temp__5808__auto___54166;
(jsprops.key = key_54167);
}
...
var temp__5808__auto___54168 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___54168 == null)){
} else {
var key_54169 = temp__5808__auto___54168;
(jsprops.key = key_54169);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54104_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__54104_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__54113 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54113,(1),null);
...
break;
default:
var G__54172 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__54173 = compiler;
v = G__54172;
compiler = G__54173;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template54131 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template54131 = (function (opts,id,fn_to_element,parse_fn,meta54132){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta54132 = meta54132;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template54131.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_54133,meta54132__$1){
var self__ = this;
var _54133__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template54131(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta54132__$1));
}));

(reagent.impl.template.t_reagent$impl$template54131.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_54133){
var self__ = this;
var _54133__$1 = this;
return self__.meta54132;
}));

(reagent.impl.template.t_reagent$impl$template54131.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template54131.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template54131.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template54131.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template54131.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template54131.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta54132","meta54132",-101385233,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template54131.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template54131.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template54131");

(reagent.impl.template.t_reagent$impl$template54131.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template54131");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template54131.
 */
reagent.impl.template.__GT_t_reagent$impl$template54131 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template54131(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54132){
return (new reagent.impl.template.t_reagent$impl$template54131(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54132));
});

}

return (new reagent.impl.template.t_reagent$impl$template54131(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
