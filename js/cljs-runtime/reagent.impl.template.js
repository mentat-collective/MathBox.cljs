...
var G__63733 = o;
reagent.impl.template.goog$module$goog$object.set(G__63733,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__63810__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63810 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63811__i = 0, G__63811__a = new Array(arguments.length -  0);
while (G__63811__i < G__63811__a.length) {G__63811__a[G__63811__i] = arguments[G__63811__i + 0]; ++G__63811__i;}
  args = new cljs.core.IndexedSeq(G__63811__a,0,null);
} 
return G__63810__delegate.call(this,args);};
G__63810.cljs$lang$maxFixedArity = 0;
G__63810.cljs$lang$applyTo = (function (arglist__63812){
var args = cljs.core.seq(arglist__63812);
return G__63810__delegate(args);
});
G__63810.cljs$core$IFn$_invoke$arity$variadic = G__63810__delegate;
return G__63810;
})()
;
} else {
...
var G__63737 = o;
reagent.impl.template.goog$module$goog$object.set(G__63737,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__63818__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63818 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63819__i = 0, G__63819__a = new Array(arguments.length -  0);
while (G__63819__i < G__63819__a.length) {G__63819__a[G__63819__i] = arguments[G__63819__i + 0]; ++G__63819__i;}
  args = new cljs.core.IndexedSeq(G__63819__a,0,null);
} 
return G__63818__delegate.call(this,args);};
G__63818.cljs$lang$maxFixedArity = 0;
G__63818.cljs$lang$applyTo = (function (arglist__63820){
var args = cljs.core.seq(arglist__63820);
return G__63818__delegate(args);
});
G__63818.cljs$core$IFn$_invoke$arity$variadic = G__63818__delegate;
return G__63818;
})()
;
} else {
...
var G__63740 = props;
var G__63740__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63740,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__63740);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63740__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__63741 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63741,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__63741;
}
})(),id_class);
...
var G__63742 = (cljs.core.count(argv) - first_child);
switch (G__63742) {
case (0):
...
var temp__5757__auto___63846 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63846 == null)){
} else {
var key_63847 = temp__5757__auto___63846;
(jsprops.key = key_63847);
}
...
var temp__5757__auto___63851 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63851 == null)){
} else {
var key_63852 = temp__5757__auto___63851;
(jsprops.key = key_63852);
}
...
var temp__5757__auto___63854 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___63854 == null)){
} else {
var key_63855 = temp__5757__auto___63854;
(jsprops.key = key_63855);
}
...
var temp__5757__auto___63861 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63861 == null)){
} else {
var key_63862 = temp__5757__auto___63861;
(jsprops.key = key_63862);
}
...
var temp__5757__auto___63863 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63863 == null)){
} else {
var key_63864 = temp__5757__auto___63863;
(jsprops.key = key_63864);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63759_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__63759_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__63762 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63762,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63762,(1),null);
...
break;
default:
var G__63873 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__63874 = compiler;
v = G__63873;
compiler = G__63874;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template63779 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template63779 = (function (opts,id,fn_to_element,parse_fn,meta63780){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta63780 = meta63780;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template63779.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_63781,meta63780__$1){
var self__ = this;
var _63781__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template63779(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta63780__$1));
}));

(reagent.impl.template.t_reagent$impl$template63779.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_63781){
var self__ = this;
var _63781__$1 = this;
return self__.meta63780;
}));

(reagent.impl.template.t_reagent$impl$template63779.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template63779.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template63779.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template63779.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template63779.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template63779.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta63780","meta63780",1868268246,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template63779.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template63779.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template63779");

(reagent.impl.template.t_reagent$impl$template63779.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template63779");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template63779.
 */
reagent.impl.template.__GT_t_reagent$impl$template63779 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template63779(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63780){
return (new reagent.impl.template.t_reagent$impl$template63779(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63780));
});

}

return (new reagent.impl.template.t_reagent$impl$template63779(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
