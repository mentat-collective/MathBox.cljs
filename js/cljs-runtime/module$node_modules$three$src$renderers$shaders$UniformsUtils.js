...
function mergeUniforms(uniforms){const merged={};for(let u=0;u<uniforms.length;u++){const tmp=cloneUniforms(uniforms[u]);for(const p in tmp)merged[p]=tmp[p]}return merged}Object.defineProperty(exports,"__esModule",{value:!0});exports.cloneUniforms=cloneUniforms;exports.mergeUniforms=mergeUniforms;exports.cloneUniformsGroups=function(src){const dst=[];for(let u=0;u<src.length;u++)dst.push(src[u].clone());return dst};exports.getUnlitUniformColorSpace=function(renderer){return null===renderer.getRenderTarget()?
renderer.outputEncoding===_constants.sRGBEncoding?_constants.SRGBColorSpace:_constants.LinearSRGBColorSpace:_constants.LinearSRGBColorSpace};exports.UniformsUtils=void 0;var _constants=require("module$node_modules$three$src$constants");exports.UniformsUtils={clone:cloneUniforms,merge:mergeUniforms}}
