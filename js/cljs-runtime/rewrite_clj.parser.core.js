...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__64471 = cljs.core.get_global_hierarchy;
return (fexpr__64471.cljs$core$IFn$_invoke$arity$0 ? fexpr__64471.cljs$core$IFn$_invoke$arity$0() : fexpr__64471.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__64472_SHARP_){
var _STAR_delimiter_STAR__orig_val__64474 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__64475 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__64475);

try{return rewrite_clj.parser.core.parse_next(p1__64472_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__64474);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___64525 = arguments.length;
var i__5770__auto___64527 = (0);
while(true){
if((i__5770__auto___64527 < len__5769__auto___64525)){
args__5775__auto__.push((arguments[i__5770__auto___64527]));

var G__64528 = (i__5770__auto___64527 + (1));
i__5770__auto___64527 = G__64528;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__64488){
var vec__64490 = p__64488;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64490,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq64480){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64481,G__64482,G__64483,seq64480__$3);
}));
...
var G__64508 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__64508)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__64508)){
...
return cljs.core.cons((function (){var G__64510 = rewrite_clj.reader.peek(reader);
switch (G__64510) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__64508)){
