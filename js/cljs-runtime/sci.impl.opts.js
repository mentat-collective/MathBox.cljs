...
var len__5769__auto___62879 = arguments.length;
var i__5770__auto___62880 = (0);
while(true){
if((i__5770__auto___62880 < len__5769__auto___62879)){
args__5775__auto__.push((arguments[i__5770__auto___62880]));

var G__62881 = (i__5770__auto___62880 + (1));
i__5770__auto___62880 = G__62881;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq62828){
var G__62829 = cljs.core.first(seq62828);
var seq62828__$1 = cljs.core.next(seq62828);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62829,seq62828__$1);
}));
...
var G__62883 = null;
var G__62883__1 = (function (msg){
return (new Error(msg));
});
var G__62883__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__62883__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__62883 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__62883__1.call(this,msg);
case 2:
return G__62883__2.call(this,msg,filename);
case 3:
return G__62883__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__62883.cljs$core$IFn$_invoke$arity$1 = G__62883__1;
G__62883.cljs$core$IFn$_invoke$arity$2 = G__62883__2;
G__62883.cljs$core$IFn$_invoke$arity$3 = G__62883__3;
return G__62883;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__62837_SHARP_){
return (new cljs.core.Delay(p1__62837_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__62838_SHARP_){
return (new goog.string.StringBuffer(p1__62838_SHARP_));
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__62852 = temp__5802__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62852,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62852,(1),null);
var G__62884 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__62885 = cljs.core.rest(kvs);
class__GT_opts = G__62884;
kvs = G__62885;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__62860){
var map__62861 = p__62860;
var map__62861__$1 = cljs.core.__destructure_map(map__62861);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62861__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62868__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334),new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334).cljs$core$IFn$_invoke$arity$1(env));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62868__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029),new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029).cljs$core$IFn$_invoke$arity$1(env));
...
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62868__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
