...
uniforms.uv2Transform.value.copy(uv2ScaleMap.matrix))}return{refreshFogUniforms:function(uniforms,fog){fog.color.getRGB(uniforms.fogColor.value,(0,_UniformsUtils.getUnlitUniformColorSpace)(renderer));fog.isFog?(uniforms.fogNear.value=fog.near,uniforms.fogFar.value=fog.far):fog.isFogExp2&&(uniforms.fogDensity.value=fog.density)},refreshMaterialUniforms:function(uniforms,material,pixelRatio,height,transmissionRenderTarget){if(material.isMeshBasicMaterial)refreshUniformsCommon(uniforms,material);else if(material.isMeshLambertMaterial)refreshUniformsCommon(uniforms,
...
(material.uniformsNeedUpdate=!1)}}};var _constants=require("module$node_modules$three$src$constants"),_UniformsUtils=require("module$node_modules$three$src$renderers$shaders$UniformsUtils")}
