...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_51480 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_51480(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_51481 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_51481(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51482 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51482(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51483 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51483(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51484 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51484(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51485 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51485(reader);
}
});
...
var G__51518 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__51519 = s.append(c);
c = G__51518;
s = G__51519;
continue;
}
