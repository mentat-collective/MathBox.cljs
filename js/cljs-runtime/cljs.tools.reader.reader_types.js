...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43896 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43896(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43897 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43897(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43898 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43898(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43899 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43899(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43903 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43903(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43904 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43904(reader);
}
});
...
var G__43914 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43915 = s.append(c);
c = G__43914;
s = G__43915;
continue;
}
