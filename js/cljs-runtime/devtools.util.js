...
var len__5769__auto___42744 = arguments.length;
var i__5770__auto___42747 = (0);
while(true){
if((i__5770__auto___42747 < len__5769__auto___42744)){
args__5775__auto__.push((arguments[i__5770__auto___42747]));

var G__42748 = (i__5770__auto___42747 + (1));
i__5770__auto___42747 = G__42748;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__42633_42750 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__42634_42751 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__42635_42752 = true;
var _STAR_print_fn_STAR__temp_val__42636_42753 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__42635_42752);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__42636_42753);

try{var _STAR_print_level_STAR__orig_val__42638_42754 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42639_42755 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42639_42755);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42638_42754);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__42634_42751);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__42633_42750);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq42618){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42618));
}));
...
var new_formatters = current_formatters.filter((function (p1__42693_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__42693_SHARP_)));
}));
...
var G__42697_42787 = f;
var target__40309__auto___42788 = G__42697_42787;
if(cljs.core.truth_(target__40309__auto___42788)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42697_42787)].join(''),"\n","target__40309__auto__"].join('')));
}

(target__40309__auto___42788["toString"] = (function (){
...
var G__42699_42789 = "%c%s";
var G__42700_42790 = "color:transparent";
var G__42701_42791 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__42699_42789,G__42700_42790,G__42701_42791) : f.call(null,G__42699_42789,G__42700_42790,G__42701_42791));
...
var args__5775__auto__ = [];
var len__5769__auto___42796 = arguments.length;
var i__5770__auto___42800 = (0);
while(true){
if((i__5770__auto___42800 < len__5769__auto___42796)){
args__5775__auto__.push((arguments[i__5770__auto___42800]));

var G__42801 = (i__5770__auto___42800 + (1));
i__5770__auto___42800 = G__42801;
continue;
} else {
}
break;
...
var vec__42712 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42712,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42712,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__42811__delegate = function (add_fmt,add_args){
...
var G__42811 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__42815__i = 0, G__42815__a = new Array(arguments.length -  1);
while (G__42815__i < G__42815__a.length) {G__42815__a[G__42815__i] = arguments[G__42815__i + 1]; ++G__42815__i;}
  add_args = new cljs.core.IndexedSeq(G__42815__a,0,null);
} 
return G__42811__delegate.call(this,add_fmt,add_args);};
G__42811.cljs$lang$maxFixedArity = 1;
G__42811.cljs$lang$applyTo = (function (arglist__42820){
var add_fmt = cljs.core.first(arglist__42820);
var add_args = cljs.core.rest(arglist__42820);
return G__42811__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq42706){
var G__42707 = cljs.core.first(seq42706);
var seq42706__$1 = cljs.core.next(seq42706);
var G__42708 = cljs.core.first(seq42706__$1);
var seq42706__$2 = cljs.core.next(seq42706__$1);
var G__42709 = cljs.core.first(seq42706__$2);
var seq42706__$3 = cljs.core.next(seq42706__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42707,G__42708,G__42709,seq42706__$3);
}));
...
var seq__42717 = cljs.core.seq(features);
var chunk__42718 = null;
var count__42719 = (0);
var i__42720 = (0);
while(true){
if((i__42720 < count__42719)){
var feature = chunk__42718.cljs$core$IIndexed$_nth$arity$2(null,i__42720);
...
var G__42835 = seq__42717;
var G__42836 = chunk__42718;
var G__42837 = count__42719;
var G__42838 = (i__42720 + (1));
seq__42717 = G__42835;
chunk__42718 = G__42836;
count__42719 = G__42837;
i__42720 = G__42838;
continue;
} else {
...
var G__42839 = cljs.core.chunk_rest(seq__42717__$1);
var G__42840 = c__5568__auto__;
var G__42841 = cljs.core.count(c__5568__auto__);
var G__42842 = (0);
seq__42717 = G__42839;
chunk__42718 = G__42840;
count__42719 = G__42841;
i__42720 = G__42842;
continue;
} else {
var feature = cljs.core.first(seq__42717__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__42843 = cljs.core.next(seq__42717__$1);
var G__42844 = null;
var G__42845 = (0);
var G__42846 = (0);
seq__42717 = G__42843;
chunk__42718 = G__42844;
count__42719 = G__42845;
i__42720 = G__42846;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o42732 = temp__5802__auto__;
return (o42732["version"]);
} else {
return null;
}
})() == null);
