...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_56518 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_56518(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_56519 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_56519(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_56520 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_56520(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_56521 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_56521(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_56529 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_56529(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_56530 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_56530(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__56512,callback){
var map__56513 = p__56512;
var map__56513__$1 = cljs.core.__destructure_map(map__56513);
var input = map__56513__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56513__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56513__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
