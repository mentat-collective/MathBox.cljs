...
var G__77346 = tag;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"var","var",870848730,null),G__77346)){
return new cljs.core.Keyword(null,"edn-var","edn-var",-1138947582);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"object","object",-1179821820,null),G__77346)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol("nextjournal","empty","nextjournal/empty",2001390345,null),G__77346)){
...
var nextjournal$viewer$ITypeKey$_type_key$dyn_77495 = (function (x){
...
return nextjournal$viewer$ITypeKey$_type_key$dyn_77495(x);
}
});
...
var G__77357 = type;
var G__77357__$1 = (((G__77357 instanceof cljs.core.Keyword))?G__77357.fqn:null);
switch (G__77357__$1) {
case "vector":
case "array":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__77357__$1)].join('')));
...
var map__77359 = nextjournal.viewer.color_classes(selected_QMARK_);
var map__77359__$1 = cljs.core.__destructure_map(map__77359);
var badge_background_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77359__$1,new cljs.core.Keyword(null,"badge-background-color","badge-background-color",1563868990));
var label_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77359__$1,new cljs.core.Keyword(null,"label-color","label-color",813573617));
...
nextjournal.viewer.more_button = (function nextjournal$viewer$more_button(visible_nb_items_ratom,p__77360){
var map__77361 = p__77360;
var map__77361__$1 = cljs.core.__destructure_map(map__77361);
var _opts = map__77361__$1;
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77361__$1,new cljs.core.Keyword(null,"expanded?","expanded?",2055832296));
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77361__$1,new cljs.core.Keyword(null,"count","count",2139924085));
...
nextjournal.viewer.browsify_button = (function nextjournal$viewer$browsify_button(path,p__77367,view){
var map__77368 = p__77367;
var map__77368__$1 = cljs.core.__destructure_map(map__77368);
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77368__$1,new cljs.core.Keyword("nextjournal","dispatch","nextjournal/dispatch",-950337451));
...
var G__77369 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"kind","kind",-717265803),new cljs.core.Keyword(null,"nav","nav",719540477),new cljs.core.Keyword(null,"path","path",-188191168),path], null);
return (dispatch.cljs$core$IFn$_invoke$arity$1 ? dispatch.cljs$core$IFn$_invoke$arity$1(G__77369) : dispatch.call(null,G__77369));
})], null),view], null);
});
/**
...
return (function (type,p__77374,coll){
var map__77375 = p__77374;
var map__77375__$1 = cljs.core.__destructure_map(map__77375);
var options = map__77375__$1;
var expanded = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77375__$1,new cljs.core.Keyword(null,"expanded","expanded",-3020742));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77375__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
var items = (function (){var G__77380 = coll;
if(cljs.core.object_QMARK_(coll)){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(G__77380);
} else {
return G__77380;
}
})();
...
var map_like_QMARK_ = (function (){var G__77381 = type;
var G__77381__$1 = (((G__77381 instanceof cljs.core.Keyword))?G__77381.fqn:null);
switch (G__77381__$1) {
case "map":
case "object":
return true;
...
var vec__77376 = nextjournal.viewer.coll_decoration(type);
var open = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77376,(0),null);
var close = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77376,(1),null);
...
})], null)),((((cljs.core.empty_QMARK_(items)) || (short_QMARK_)))?null:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.disclose","div.disclose",-1582817702),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(expanded_QMARK_)?null:"collapsed")], null)], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227),(function (){var G__77384 = type;
var G__77384__$1 = (((G__77384 instanceof cljs.core.Keyword))?G__77384.fqn:null);
switch (G__77384__$1) {
case "map":
return "Map";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__77384__$1)].join('')));
...
var G__77387 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(map_like_QMARK_)?"cmt-atom":"cmt-number")], null),(cljs.core.truth_(map_like_QMARK_)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.update.cljs$core$IFn$_invoke$arity$4(options,new cljs.core.Keyword(null,"path","path",-188191168),cljs.core.conj,i),item__$1], null):i),": "], null);
if(cljs.core.truth_(nextjournal.viewer.navigable_item_QMARK_(options,path,item__$1))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.browsify_button,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("nav","path","nav/path",-188053725).cljs$core$IFn$_invoke$arity$1(options),item__$1),options], null),G__77387);
} else {
return G__77387;
}
...
try{var v = (function (){var obj77389 = obj;
if((!((obj77389 == null)))){
return (obj77389[applied_science.js_interop.impl.wrap_key(k)]);
} else {
return undefined;
}
})();
...
return v;
}catch (e77388){if((e77388 instanceof Error)){
var _ = e77388;
...
var visible_nb_items = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((20));
return (function (inspect,p__77390,obj){
var map__77391 = p__77390;
var map__77391__$1 = cljs.core.__destructure_map(map__77391);
var options = map__77391__$1;
var expanded = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77391__$1,new cljs.core.Keyword(null,"expanded","expanded",-3020742));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77391__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(expanded),path);
var parent = cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$1(path));
var short_QMARK_ = ((cljs.core.seq(path)) && (cljs.core.not(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(expanded),parent))));
...
})())?null:(function (){var iter__4652__auto__ = (function nextjournal$viewer$inspect_object_$_iter__77392(s__77393){
return (new cljs.core.LazySeq(null,(function (){
var s__77393__$1 = s__77393;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__77393__$1);
if(temp__5753__auto__){
var s__77393__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__77393__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__77393__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__77395 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__77394 = (0);
while(true){
if((i__77394 < size__4651__auto__)){
var k = cljs.core._nth(c__4650__auto__,i__77394);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__77395),nextjournal$viewer$inspect_object_$_iter__77392(cljs.core.chunk_rest(s__77393__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__77395),null);
}
} else {
var k = cljs.core.first(s__77393__$2);
if(cljs.core.truth_((function (){var or__4253__auto__ = cljs.core.not(t);
if(or__4253__auto__){
return or__4253__auto__;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.meta(data),new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947),(function (){var G__77405 = data;
...
return cljs.core.with_meta(G__77405,cljs.core.PersistentArrayMap.EMPTY);
} else {
return G__77405;
}
})());
...
var len__4864__auto___77513 = arguments.length;
var i__4865__auto___77514 = (0);
while(true){
if((i__4865__auto___77514 < len__4864__auto___77513)){
args__4870__auto__.push((arguments[i__4865__auto___77514]));

var G__77515 = (i__4865__auto___77514 + (1));
i__4865__auto___77514 = G__77515;
continue;
} else {
}
break;
...
/** @this {Function} */
(nextjournal.viewer.vary_meta.cljs$lang$applyTo = (function (seq77419){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__77420,G__77421,seq77419__$2);
}));
...
if(cljs.core.truth_((function (){var obj77427 = v;
if((!((obj77427 == null)))){
return (obj77427["parentNode"]);
} else {
return undefined;
}
})())){
...
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"reagent","reagent",2131627322),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__77424_SHARP_){
if(cljs.core.truth_(p1__77424_SHARP_)){
var temp__5753__auto___77516 = p1__77424_SHARP_.firstChild;
if(cljs.core.truth_(temp__5753__auto___77516)){
var childElement_77517 = temp__5753__auto___77516;
p1__77424_SHARP_.removeChild(childElement_77517);
} else {
}

return p1__77424_SHARP_.appendChild(v);
} else {
return null;
}
})], null)], null));
...
}),(function (p1__77423_SHARP_){
return reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(p1__77423_SHARP_);
}),nextjournal.viewer.plotly.viewer,nextjournal.viewer.code.viewer,nextjournal.viewer.mathjax.viewer,(function (p1__77425_SHARP_){
return reagent.core.as_element.cljs$core$IFn$_invoke$arity$1((function (){var G__77428 = p1__77425_SHARP_;
if(cljs.core.fn_QMARK_(p1__77425_SHARP_)){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__77428],null));
} else {
return G__77428;
}
})());
...
var fexpr__77430 = (((viewer instanceof cljs.core.Keyword))?(function (){var or__4253__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal","viewers","nextjournal/viewers",1064728841),viewer], null));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var or__4253__auto____$1 = (function (){var fexpr__77431 = cljs.core.deref(nextjournal.viewer._BANG_viewers);
return (fexpr__77431.cljs$core$IFn$_invoke$arity$1 ? fexpr__77431.cljs$core$IFn$_invoke$arity$1(viewer) : fexpr__77431.call(null,viewer));
})();
...
return (fexpr__77430.cljs$core$IFn$_invoke$arity$2 ? fexpr__77430.cljs$core$IFn$_invoke$arity$2(value,options) : fexpr__77430.call(null,value,options));
});
...
var map__77445 = (function (){var G__77447 = options;
if(cljs.core.not(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(options))){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__77447,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",-188191168),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"expanded","expanded",-3020742),reagent.core.state_atom(reagent.core.current_component())], null)], 0));
} else {
return G__77447;
}
})();
var map__77445__$1 = cljs.core.__destructure_map(map__77445);
var options__$1 = map__77445__$1;
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77445__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var expanded = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77445__$1,new cljs.core.Keyword(null,"expanded","expanded",-3020742));
var map__77446 = nextjournal.viewer.meta(data);
var map__77446__$1 = cljs.core.__destructure_map(map__77446);
var value_meta = map__77446__$1;
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77446__$1,new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77446__$1,new cljs.core.Keyword("nextjournal","tag","nextjournal/tag",1515661557));
...
var fexpr__77451 = cljs.core.deref(nextjournal.viewer._BANG_viewers);
return (fexpr__77451.cljs$core$IFn$_invoke$arity$1 ? fexpr__77451.cljs$core$IFn$_invoke$arity$1(viewer_key) : fexpr__77451.call(null,viewer_key));
}
}
})();
...
var G__77452 = type_key;
var G__77452__$1 = (((G__77452 instanceof cljs.core.Keyword))?G__77452.fqn:null);
switch (G__77452__$1) {
case "edn-var":
...
var G__77453 = value;
if(cljs.core.seq(m)){
return nextjournal.viewer.vary_meta.cljs$core$IFn$_invoke$arity$variadic(G__77453,cljs.core.merge,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m], 0));
} else {
return G__77453;
}
})()], null)], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__77452__$1)].join('')));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (){var G__77456 = nextjournal.viewer.inspect;
...
return cljs.core.partial.cljs$core$IFn$_invoke$arity$2(G__77456,nextjournal.viewer.meta(x));
} else {
return G__77456;
}
})());
...
var evolve = (function (p1__77457_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(rule30,cljs.core.partition.cljs$core$IFn$_invoke$arity$4((3),(1),cljs.core.repeat.cljs$core$IFn$_invoke$arity$1((0)),cljs.core.cons((0),p1__77457_SHARP_)));
});
...
return (function (state){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.result-data","div.result-data",-1539734720),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,nextjournal.viewer.with_viewers(nextjournal.viewer.with_viewer(cljs.core.deref(state),new cljs.core.Keyword(null,"board","board",-1907017633)),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"cell","cell",764245084),(function (p1__77464_SHARP_){
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.inline-block","div.inline-block",-502349916),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(((p1__77464_SHARP_ === (0)))?"bg-white border-solid border-2 border-black":"bg-black"),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(16),new cljs.core.Keyword(null,"height","height",1025178622),(16)], null)], null)], null));
}),new cljs.core.Keyword(null,"row","row",-570139521),(function (x,options){
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.inline-flex","div.flex.inline-flex",1792928195)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__77465_SHARP_){
return nextjournal.viewer.inspect.cljs$core$IFn$_invoke$arity$2(options,nextjournal.viewer.view_as(new cljs.core.Keyword(null,"cell","cell",764245084),p1__77465_SHARP_));
}),x)));
}),new cljs.core.Keyword(null,"board","board",-1907017633),(function (x,options){
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-col","div.flex.flex-col",255067761)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__77466_SHARP_){
return nextjournal.viewer.inspect.cljs$core$IFn$_invoke$arity$2(options,nextjournal.viewer.view_as(new cljs.core.Keyword(null,"row","row",-570139521),p1__77466_SHARP_));
}),x)));
})], null))], null)], null);
});
...
var cell = (function (p1__77469_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"div.inline-block","div.inline-block",-502349916),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(((p1__77469_SHARP_ === (0)))?"bg-white border-solid border-2 border-black":"bg-black"),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(16),new cljs.core.Keyword(null,"height","height",1025178622),(16)], null)], null)],null));
});
var row = (function (p1__77470_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.inline-flex","div.flex.inline-flex",1792928195)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1(cell),p1__77470_SHARP_);
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,nextjournal.viewer.with_viewer(cljs.core.list(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(1),(0)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(0),(1)], null)),cljs.core.list(new cljs.core.Symbol(null,"fn","fn",465265323,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"board","board",-266486106,null)], null),cljs.core.list(new cljs.core.Symbol(null,"let","let",358118826,null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"cell","cell",-1890190685,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__77472#","p1__77472#",2024807454,null)], null),cljs.core.list(new cljs.core.Symbol(null,"vector","vector",-751469611,null),new cljs.core.Keyword(null,"div.inline-block","div.inline-block",-502349916),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"zero?","zero?",325758897,null),new cljs.core.Symbol(null,"p1__77472#","p1__77472#",2024807454,null)),"bg-white border-solid border-2 border-black","bg-black"),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(16),new cljs.core.Keyword(null,"height","height",1025178622),(16)], null)], null))),new cljs.core.Symbol(null,"row","row",1070392006,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__77473#","p1__77473#",-1659045561,null)], null),cljs.core.list(new cljs.core.Symbol(null,"into","into",1489695498,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.inline-flex","div.flex.inline-flex",1792928195)], null),cljs.core.list(new cljs.core.Symbol(null,"map","map",-1282745308,null),new cljs.core.Symbol(null,"cell","cell",-1890190685,null)),new cljs.core.Symbol(null,"p1__77473#","p1__77473#",-1659045561,null)))], null),cljs.core.list(new cljs.core.Symbol("v","html","v/html",641734256,null),cljs.core.list(new cljs.core.Symbol(null,"into","into",1489695498,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-col","div.flex.flex-col",255067761)], null),cljs.core.list(new cljs.core.Symbol(null,"map","map",-1282745308,null),new cljs.core.Symbol(null,"row","row",1070392006,null)),new cljs.core.Symbol(null,"board","board",-266486106,null))))))], null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__4652__auto__ = (function nextjournal$viewer$iter__77474(s__77475){
return (new cljs.core.LazySeq(null,(function (){
var s__77475__$1 = s__77475;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__77475__$1);
if(temp__5753__auto__){
var s__77475__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__77475__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__77475__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__77477 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__77476 = (0);
while(true){
if((i__77476 < size__4651__auto__)){
var value = cljs.core._nth(c__4650__auto__,i__77476);
cljs.core.chunk_append(b__77477,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer","div.mb-3.result-viewer",896613001),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value","code.inspected-value",521789178),(function (){var _STAR_print_meta_STAR__orig_val__77478 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__77479 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__77479);
...
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__77478);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__77477),nextjournal$viewer$iter__77474(cljs.core.chunk_rest(s__77475__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__77477),null);
}
} else {
var value = cljs.core.first(s__77475__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer","div.mb-3.result-viewer",896613001),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value","code.inspected-value",521789178),(function (){var _STAR_print_meta_STAR__orig_val__77480 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__77481 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__77481);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([value], 0));
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__77480);
}})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227)," => "], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.PersistentArrayMap.EMPTY,value], null)], null),nextjournal$viewer$iter__77474(cljs.core.rest(s__77475__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.p-6","div.p-6",1412057822)], null),(function (){var iter__4652__auto__ = (function nextjournal$viewer$iter__77482(s__77483){
return (new cljs.core.LazySeq(null,(function (){
var s__77483__$1 = s__77483;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__77483__$1);
if(temp__5753__auto__){
var s__77483__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__77483__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__77483__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__77485 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__77484 = (0);
while(true){
if((i__77484 < size__4651__auto__)){
var value = cljs.core._nth(c__4650__auto__,i__77484);
cljs.core.chunk_append(b__77485,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer.dark:text-slate-300","div.mb-3.result-viewer.dark:text-slate-300",-1022028343),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value.dark:bg-transparent.dark:text-slate-300","code.inspected-value.dark:bg-transparent.dark:text-slate-300",1787800450),(function (){var _STAR_print_meta_STAR__orig_val__77486 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__77487 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__77487);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([value], 0));
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__77486);
}})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227)," => "], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.PersistentArrayMap.EMPTY,value], null)], null));

var G__77552 = (i__77484 + (1));
i__77484 = G__77552;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__77485),nextjournal$viewer$iter__77482(cljs.core.chunk_rest(s__77483__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__77485),null);
}
} else {
var value = cljs.core.first(s__77483__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer.dark:text-slate-300","div.mb-3.result-viewer.dark:text-slate-300",-1022028343),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value.dark:bg-transparent.dark:text-slate-300","code.inspected-value.dark:bg-transparent.dark:text-slate-300",1787800450),(function (){var _STAR_print_meta_STAR__orig_val__77488 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__77489 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__77489);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([value], 0));
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__77488);
}})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227)," => "], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.PersistentArrayMap.EMPTY,value], null)], null),nextjournal$viewer$iter__77482(cljs.core.rest(s__77483__$2)));
}
} else {
return null;
}
...
return (function (state){
var map__77490 = cljs.core.deref(state);
var map__77490__$1 = cljs.core.__destructure_map(map__77490);
var clj = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77490__$1,new cljs.core.Keyword(null,"clj","clj",-660495428));
var clj_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77490__$1,new cljs.core.Keyword(null,"clj-map","clj-map",-730949109));
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77490__$1,new cljs.core.Keyword(null,"js","js",1768080579));
...
var G__77553 = (x__$1 - (1));
var G__77554 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(res,gen_keyword(),(val_fun.cljs$core$IFn$_invoke$arity$0 ? val_fun.cljs$core$IFn$_invoke$arity$0() : val_fun.call(null)));
x__$1 = G__77553;
res = G__77554;
continue;
...
var with_let77491 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let77491","with-let77491",-1394379591));
var temp__5757__auto___77559 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___77559 == null)){
} else {
var c__62648__auto___77560 = temp__5757__auto___77559;
if((with_let77491.generation === c__62648__auto___77560.ratomGeneration)){
