...
var len__4864__auto___55065 = arguments.length;
var i__4865__auto___55066 = (0);
while(true){
if((i__4865__auto___55066 < len__4864__auto___55065)){
args_arr__4885__auto__.push((arguments[i__4865__auto___55066]));

var G__55068 = (i__4865__auto___55066 + (1));
i__4865__auto___55066 = G__55068;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq55018){
...
var G__55022 = cljs.core.first(seq55018__$3);
var seq55018__$4 = cljs.core.next(seq55018__$3);
var G__55023 = cljs.core.first(seq55018__$4);
var seq55018__$5 = cljs.core.next(seq55018__$4);
var G__55024 = cljs.core.first(seq55018__$5);
var seq55018__$6 = cljs.core.next(seq55018__$5);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55019,G__55020,G__55021,G__55022,G__55023,G__55024,seq55018__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__55043){
var vec__55044 = p__55043;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55044,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55044,(1),null);
