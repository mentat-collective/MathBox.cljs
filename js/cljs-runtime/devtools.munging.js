...
var o40864 = temp__5802__auto__;
var temp__5802__auto____$1 = (o40864["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o40865 = temp__5802__auto____$1;
return (o40865["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40292__auto__ = f;
return (o__40292__auto__["toString"]).call(o__40292__auto__);
} else {
return "";
}
}catch (e40871){var _ = e40871;
return "";
}});
...
try{var o__40292__auto___41408 = t;
(o__40292__auto___41408["cljs$lang$ctorPrWriter"]).call(o__40292__auto___41408,t,writer);
}catch (e40884){var __41410 = e40884;
}
...
var char_code = (function (){var o__40292__auto__ = (new String(char$));
return (o__40292__auto__["charCodeAt"]).call(o__40292__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40292__auto__ = String;
return (o__40292__auto__["fromCharCode"]).call(o__40292__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40953 = num_code;
switch (G__40953) {
case (1):
return (185);
...
var o__40292__auto__ = String;
return (o__40292__auto__["fromCharCode"]).call(o__40292__auto__,superscript_code);
});
/**
...
}catch (e40976){var _e__40311__auto__ = e40976;
return false;
}})())){
...
var vec__40977 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40977,(0),null);
...
var len__5769__auto___41424 = arguments.length;
var i__5770__auto___41425 = (0);
while(true){
if((i__5770__auto___41425 < len__5769__auto___41424)){
args__5775__auto__.push((arguments[i__5770__auto___41425]));

var G__41426 = (i__5770__auto___41425 + (1));
i__5770__auto___41425 = G__41426;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40991){
var vec__40992 = p__40991;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40992,(0),null);
...
var G__41432 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41433 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41432;
remaining_tokens = G__41433;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40987){
var G__40988 = cljs.core.first(seq40987);
var seq40987__$1 = cljs.core.next(seq40987);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40988,seq40987__$1);
}));
...
var vec__41002 = cljs.core.split_with((function (p1__40999_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40999_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41002,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41002,(1),null);
...
var vec__41059 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41059,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41059,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41436 = cljs.core.rest(remaining_tokens);
var G__41437 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41436;
name_tokens = G__41437;
continue;
} else {
...
var vec__41067 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41067,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41067,(1),null);
var vec__41070 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41070,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41070,(1),null);
var vec__41073 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41073,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41073,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41073,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41073,(3),null);
...
var vec__41081 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41081,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41081,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41081,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41081,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41081,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41081,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__41089 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41089,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41089,(1),null);
var vec__41093 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41093,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41093,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41097 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41097) : devtools.munging.parse_fn_info_deep.call(null,G__41097));
})()));
}
} else {
return fn_info;
...
var G__41463 = (arity + (1));
var G__41464 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41121){
var vec__41123 = p__41121;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41123,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41123,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41156_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41156_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41157_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41157_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41162){
var vec__41163 = p__41162;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41163,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41160){
var G__41161 = cljs.core.first(seq41160);
var seq41160__$1 = cljs.core.next(seq41160);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41161,seq41160__$1);
}));
...
var G__41166 = arg;
var G__41166__$1 = (((G__41166 instanceof cljs.core.Keyword))?G__41166.fqn:null);
switch (G__41166__$1) {
...
var map__41190 = options;
var map__41190__$1 = cljs.core.__destructure_map(map__41190);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41190__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41190__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41190__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41190__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41192 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(5),null);
...
var o__40292__auto__ = f;
return (o__40292__auto__["getBasis"]).call(o__40292__auto__);
});
/**
...
}catch (e41231){var _e__40311__auto__ = e41231;
...
var G__41485 = (obj[cljs.core.first(path)]);
var G__41486 = cljs.core.rest(path);
obj = G__41485;
path = G__41486;
continue;
} else {
...
var _STAR_ = (function (accum,p__41355){
var vec__41358 = p__41355;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41358,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41358,(1),null);
...
var vec__41374 = p__41371;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41374,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41374,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41374,(2),null);
...
var post_process = (function (p__41389){
var vec__41390 = p__41389;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41390,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41390,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41382_SHARP_){
return (obj[cljs.core.first(p1__41382_SHARP_)]);
}),sorted_matches);
