...
function scrollRectIntoView(dom,rect$jscomp$0,side,x,y,xMargin,yMargin,ltr){let doc=dom.ownerDocument,win=doc.defaultView||window;for(;dom;)if(1==dom.nodeType){let top=dom==doc.body;if(top){var JSCompiler_object_inline_left_5831=0;var JSCompiler_object_inline_right_5832=win.innerWidth;var JSCompiler_object_inline_top_5833=0;var JSCompiler_object_inline_bottom_5834=win.innerHeight}else{if(dom.scrollHeight<=dom.clientHeight&&dom.scrollWidth<=dom.clientWidth){dom=dom.assignedSlot||dom.parentNode;continue}var rect=
dom.getBoundingClientRect();JSCompiler_object_inline_left_5831=rect.left;JSCompiler_object_inline_right_5832=rect.left+dom.clientWidth;JSCompiler_object_inline_top_5833=rect.top;JSCompiler_object_inline_bottom_5834=rect.top+dom.clientHeight}var moveY=rect=0;"nearest"==y?rect$jscomp$0.top<JSCompiler_object_inline_top_5833?(moveY=-(JSCompiler_object_inline_top_5833-rect$jscomp$0.top+yMargin),0<side&&rect$jscomp$0.bottom>JSCompiler_object_inline_bottom_5834+moveY&&(moveY=rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_5834+
moveY+yMargin)):rect$jscomp$0.bottom>JSCompiler_object_inline_bottom_5834&&(moveY=rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_5834+yMargin,0>side&&rect$jscomp$0.top-moveY<JSCompiler_object_inline_top_5833&&(moveY=-(JSCompiler_object_inline_top_5833+moveY-rect$jscomp$0.top+yMargin))):(moveY=rect$jscomp$0.bottom-rect$jscomp$0.top,JSCompiler_object_inline_bottom_5834-=JSCompiler_object_inline_top_5833,moveY=("center"==y&&moveY<=JSCompiler_object_inline_bottom_5834?rect$jscomp$0.top+moveY/2-
JSCompiler_object_inline_bottom_5834/2:"start"==y||"center"==y&&0>side?rect$jscomp$0.top-yMargin:rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_5834+yMargin)-JSCompiler_object_inline_top_5833);"nearest"==x?rect$jscomp$0.left<JSCompiler_object_inline_left_5831?(rect=-(JSCompiler_object_inline_left_5831-rect$jscomp$0.left+xMargin),0<side&&rect$jscomp$0.right>JSCompiler_object_inline_right_5832+rect&&(rect=rect$jscomp$0.right-JSCompiler_object_inline_right_5832+rect+xMargin)):rect$jscomp$0.right>
JSCompiler_object_inline_right_5832&&(rect=rect$jscomp$0.right-JSCompiler_object_inline_right_5832+xMargin,0>side&&rect$jscomp$0.left<JSCompiler_object_inline_left_5831+rect&&(rect=-(JSCompiler_object_inline_left_5831+rect-rect$jscomp$0.left+xMargin))):rect=("center"==x?rect$jscomp$0.left+(rect$jscomp$0.right-rect$jscomp$0.left)/2-(JSCompiler_object_inline_right_5832-JSCompiler_object_inline_left_5831)/2:"start"==x==ltr?rect$jscomp$0.left-xMargin:rect$jscomp$0.right-(JSCompiler_object_inline_right_5832-
JSCompiler_object_inline_left_5831)+xMargin)-JSCompiler_object_inline_left_5831;if(rect||moveY)top?win.scrollBy(rect,moveY):(JSCompiler_object_inline_right_5832=JSCompiler_object_inline_left_5831=0,moveY&&(JSCompiler_object_inline_right_5832=dom.scrollTop,dom.scrollTop+=moveY,JSCompiler_object_inline_right_5832=dom.scrollTop-JSCompiler_object_inline_right_5832),rect&&(JSCompiler_object_inline_left_5831=dom.scrollLeft,dom.scrollLeft+=rect,JSCompiler_object_inline_left_5831=dom.scrollLeft-JSCompiler_object_inline_left_5831),
rect$jscomp$0={left:rect$jscomp$0.left-JSCompiler_object_inline_left_5831,top:rect$jscomp$0.top-JSCompiler_object_inline_right_5832,right:rect$jscomp$0.right-JSCompiler_object_inline_left_5831,bottom:rect$jscomp$0.bottom-JSCompiler_object_inline_right_5832},JSCompiler_object_inline_left_5831&&1>Math.abs(JSCompiler_object_inline_left_5831-rect)&&(x="nearest"),JSCompiler_object_inline_right_5832&&1>Math.abs(JSCompiler_object_inline_right_5832-moveY)&&(y="nearest"));if(top)break;dom=dom.assignedSlot||
...
let last=lastMouseDown,lastTime=lastMouseDownTime;lastMouseDown=event;lastMouseDownTime=Date.now();return lastMouseDownCount=!last||lastTime>Date.now()-400&&2>Math.abs(last.clientX-event.clientX)&&2>Math.abs(last.clientY-event.clientY)?(lastMouseDownCount+1)%3:1}function basicMouseSelection(view,event$jscomp$0){let start=queryPos(view,event$jscomp$0),type=getClickType(event$jscomp$0),startSel=view.state.selection;return{update(update){update.docChanged&&(start.pos=update.changes.mapPos(start.pos),
startSel=startSel.map(update.changes))},get(event,extend,multiple){event=queryPos(view,event);let range=rangeForClick(view,event.pos,event.bias,type);if(start.pos!=event.pos&&!extend){var startRange=rangeForClick(view,start.pos,start.bias,type);event=Math.min(startRange.from,range.from);startRange=Math.max(startRange.to,range.to);range=event<range.from?state$jscomp$0.EditorSelection.range(event,startRange):state$jscomp$0.EditorSelection.range(startRange,event)}return extend?startSel.replaceRange(startSel.main.extend(range.from,
range.to)):multiple&&1<startSel.ranges.length&&startSel.ranges.some(r=>r.eq(range))?removeRange(startSel,range):multiple?startSel.addRange(range):state$jscomp$0.EditorSelection.create([range])}}}function removeRange(sel,range){for(let i=0;;i++)if(sel.ranges[i].eq(range))return state$jscomp$0.EditorSelection.create(sel.ranges.slice(0,i).concat(sel.ranges.slice(i+1)),sel.mainIndex==i?0:sel.mainIndex-(sel.mainIndex>i?1:0))}function dropText(view,event,text,direct){if(text){var dropPos=view.posAtCoords({x:event.clientX,
y:event.clientY},!1);event.preventDefault();({mouseSelection:event}=view.inputState);direct=direct&&event&&event.dragging&&event.dragMove?{from:event.dragging.from,to:event.dragging.to}:null;text={from:dropPos,insert:text};text=view.state.changes(direct?[direct,text]:text);view.focus();view.dispatch({changes:text,selection:{anchor:text.mapPos(dropPos,-1),head:text.mapPos(dropPos,1)},userEvent:direct?"move.drop":"input.drop"})}}function captureCopy(view,text){let parent=view.dom.parentNode;if(parent){var target=
parent.appendChild(document.createElement("textarea"));target.style.cssText="position: fixed; left: -10000px; top: 10px";target.value=text;target.focus();target.selectionEnd=text.length;target.selectionStart=0;setTimeout(()=>{target.remove();view.focus()},50)}}function updateForFocusChange(view){setTimeout(()=>{view.hasFocus!=view.inputState.notifiedFocused&&view.update([])},10)}function mergeGaps(nodes,around){let before,after;null==nodes[around]&&(before=nodes[around-1])instanceof HeightMapGap&&
(after=nodes[around+1])instanceof HeightMapGap&&nodes.splice(around-1,3,new HeightMapGap(before.length+1+after.length))}function heightRelevantDecoChanges(a,b,diff){let comp=new DecorationComparator;state$jscomp$0.RangeSet.compare(a,b,diff,comp,0);return comp.changes}function visiblePixelRange(dom,paddingTop){let rect=dom.getBoundingClientRect(),doc=dom.ownerDocument;var win=doc.defaultView||window;let left=Math.max(0,rect.left),right=Math.min(win.innerWidth,rect.right),top=Math.max(0,rect.top);win=
Math.min(win.innerHeight,rect.bottom);for(let parent=dom.parentNode;parent&&parent!=doc.body;)if(1==parent.nodeType){let elt=parent,style=window.getComputedStyle(elt);if((elt.scrollHeight>elt.clientHeight||elt.scrollWidth>elt.clientWidth)&&"visible"!=style.overflow){let parentRect=elt.getBoundingClientRect();left=Math.max(left,parentRect.left);right=Math.min(right,parentRect.right);top=Math.max(top,parentRect.top);win=parent==dom.parentNode?parentRect.bottom:Math.min(win,parentRect.bottom)}parent=
"absolute"==style.position||"fixed"==style.position?elt.offsetParent:elt.parentNode}else if(11==parent.nodeType)parent=parent.host;else break;return{left:left-rect.left,right:Math.max(left,right)-rect.left,top:top-(rect.top+paddingTop),bottom:Math.max(top,win)-(rect.top+paddingTop)}}function fullPixelRange(dom,paddingTop){dom=dom.getBoundingClientRect();return{left:0,right:dom.right-dom.left,top:paddingTop,bottom:dom.bottom-(dom.top+paddingTop)}}function lineStructure(from$jscomp$0,to$jscomp$0,stateDeco){let ranges=
[],pos=from$jscomp$0,total=0;state$jscomp$0.RangeSet.spans(stateDeco,from$jscomp$0,to$jscomp$0,{span(){},point(from,to){from>pos&&(ranges.push({from:pos,to:from}),total+=from-pos);pos=to}},20);pos<to$jscomp$0&&(ranges.push({from:pos,to:to$jscomp$0}),total+=to$jscomp$0-pos);return{total,ranges}}function findPosition({total,ranges},ratio){if(0>=ratio)return ranges[0].from;if(1<=ratio)return ranges[ranges.length-1].to;total=Math.floor(total*ratio);for(ratio=0;;ratio++){let {from,to}=ranges[ratio],size=
to-from;if(total<=size)return from+total;total-=size}}function findFraction(structure,pos){let counted=0;for(let {from,to}of structure.ranges){if(pos<=to){counted+=pos-from;break}counted+=to-from}return counted/structure.total}function find(array,f){for(let val of array)if(f(val))return val}function scaleBlock(block,scaler){if(1==scaler.scale)return block;let bTop=scaler.toDOM(block.top),bBottom=scaler.toDOM(block.bottom);return new BlockInfo(block.from,block.length,bTop,bBottom-bTop,Array.isArray(block.type)?
block.type.map(b=>scaleBlock(b,scaler)):block.type)}function buildTheme(main,spec,scopes){return new styleMod.StyleModule(spec,{finish(sel){return/&/.test(sel)?sel.replace(/&\w*/,m=>{if("\x26"==m)return main;if(!scopes||!scopes[m])throw new RangeError(`Unsupported selector: ${m}`);return scopes[m]}):main+" "+sel}})}function applyDOMChange(view,domChange){let change;var {newSel}=domChange;let sel=view.state.selection.main;if(domChange.bounds){let {from,to}=domChange.bounds;var preferredPos=sel.from;
let preferredSide=null;if(8===view.inputState.lastKeyCode&&view.inputState.lastKeyTime>Date.now()-100||browser.android&&domChange.text.length<to-from)preferredPos=sel.to,preferredSide="end";if(preferredPos=findDiff(view.state.doc.sliceString(from,to,"￿"),domChange.text,preferredPos-from,preferredSide))browser.chrome&&13==view.inputState.lastKeyCode&&preferredPos.toB==preferredPos.from+2&&"￿￿"==domChange.text.slice(preferredPos.from,preferredPos.toB)&&preferredPos.toB--,change={from:from+preferredPos.from,
to:from+preferredPos.toA,insert:state$jscomp$0.Text.of(domChange.text.slice(preferredPos.from,preferredPos.toB).split("￿"))}}else!newSel||view.hasFocus&&view.state.facet(editable)&&!newSel.main.eq(sel)||(newSel=null);if(!change&&!newSel)return!1;!change&&domChange.typeOver&&!sel.empty&&newSel&&newSel.main.empty?change={from:sel.from,to:sel.to,insert:view.state.doc.slice(sel.from,sel.to)}:change&&change.from>=sel.from&&change.to<=sel.to&&(change.from!=sel.from||change.to!=sel.to)&&4>=sel.to-sel.from-
(change.to-change.from)?change={from:sel.from,to:sel.to,insert:view.state.doc.slice(sel.from,change.from).append(change.insert).append(view.state.doc.slice(change.to,sel.to))}:(browser.mac||browser.android)&&change&&change.from==change.to&&change.from==sel.head-1&&/^\. ?$/.test(change.insert.toString())?(newSel&&2==change.insert.length&&(newSel=state$jscomp$0.EditorSelection.single(newSel.main.anchor-1,newSel.main.head-1)),change={from:sel.from,to:sel.to,insert:state$jscomp$0.Text.of([" "])}):browser.chrome&&
change&&change.from==change.to&&change.from==sel.head&&"\n "==change.insert.toString()&&view.lineWrapping&&(newSel&&(newSel=state$jscomp$0.EditorSelection.single(newSel.main.anchor-1,newSel.main.head-1)),change={from:sel.from,to:sel.to,insert:state$jscomp$0.Text.of([" "])});if(change){let startState=view.state;if(browser.ios&&view.inputState.flushIOSKey(view)||browser.android&&(change.from==sel.from&&change.to==sel.to&&1==change.insert.length&&2==change.insert.lines&&dispatchKey(view.contentDOM,"Enter",
13)||change.from==sel.from-1&&change.to==sel.to&&0==change.insert.length&&dispatchKey(view.contentDOM,"Backspace",8)||change.from==sel.from&&change.to==sel.to+1&&0==change.insert.length&&dispatchKey(view.contentDOM,"Delete",46)))return!0;let text=change.insert.toString();if(view.state.facet(inputHandler).some(h=>h(view,change.from,change.to,text)))return!0;0<=view.inputState.composing&&view.inputState.composing++;if(change.from>=sel.from&&change.to<=sel.to&&change.to-change.from>=(sel.to-sel.from)/
3&&(!newSel||newSel.main.empty&&newSel.main.from==change.from+change.insert.length)&&0>view.inputState.composing)newSel=sel.from<change.from?startState.sliceDoc(sel.from,change.from):"",domChange=sel.to>change.to?startState.sliceDoc(change.to,sel.to):"",newSel=startState.replaceSelection(view.state.toText(newSel+change.insert.sliceString(0,void 0,view.state.lineBreak)+domChange));else{let changes=startState.changes(change),mainSel=newSel&&!startState.selection.main.eq(newSel.main)&&newSel.main.to<=
changes.newLength?newSel.main:void 0;if(1<startState.selection.ranges.length&&0<=view.inputState.composing&&change.to<=sel.to&&change.to>=sel.to-10){let replaced=view.state.sliceDoc(change.from,change.to),compositionRange=compositionSurroundingNode(view)||view.state.doc.lineAt(sel.head),offset=sel.to-change.to,size=sel.to-sel.from;newSel=startState.changeByRange(range=>{if(range.from==sel.from&&range.to==sel.to)return{changes,range:mainSel||range.map(changes)};var to=range.to-offset,from=to-replaced.length;
if(range.to-range.from!=size||view.state.sliceDoc(from,to)!=replaced||compositionRange&&range.to>=compositionRange.from&&range.from<=compositionRange.to)return{range};to=startState.changes({from,to,insert:change.insert});from=range.to-sel.to;return{changes:to,range:mainSel?state$jscomp$0.EditorSelection.range(Math.max(0,mainSel.anchor+from),Math.max(0,mainSel.head+from)):range.map(to)}})}else newSel={changes,selection:mainSel&&startState.selection.replaceRange(mainSel)}}domChange="input.type";view.composing&&
(domChange+=".compose",view.inputState.compositionFirstChange&&(domChange+=".start",view.inputState.compositionFirstChange=!1));view.dispatch(newSel,{scrollIntoView:!0,userEvent:domChange});return!0}return newSel&&!newSel.main.eq(sel)?(domChange=!1,preferredPos="select",view.inputState.lastSelectionTime>Date.now()-50&&("select"==view.inputState.lastSelectionOrigin&&(domChange=!0),preferredPos=view.inputState.lastSelectionOrigin),view.dispatch({selection:newSel,scrollIntoView:domChange,userEvent:preferredPos}),
!0):!1}function findDiff(a,b,preferredPos,preferredSide){var minLen=Math.min(a.length,b.length);let from=0;for(;from<minLen&&a.charCodeAt(from)==b.charCodeAt(from);)from++;if(from==minLen&&a.length==b.length)return null;minLen=a.length;let toB=b.length;for(;0<minLen&&0<toB&&a.charCodeAt(minLen-1)==b.charCodeAt(toB-1);)minLen--,toB--;"end"==preferredSide&&(preferredPos-=minLen+Math.max(0,from-Math.min(minLen,toB))-from);minLen<from&&a.length<b.length?(from-=preferredPos<=from&&preferredPos>=minLen?
from-preferredPos:0,toB=from+(toB-minLen),minLen=from):toB<from&&(from-=preferredPos<=from&&preferredPos>=toB?from-preferredPos:0,minLen=from+(minLen-toB),toB=from);return{from,toA:minLen,toB}}function findChild(cView,dom,dir){for(;dom;){var curView=ContentView.get(dom);if(curView&&curView.parent==cView)return curView;curView=dom.parentNode;dom=curView!=cView.dom?curView:0<dir?dom.nextSibling:dom.previousSibling}return null}function safariSelectionRangeHack(view){function read(event){event.preventDefault();
event.stopImmediatePropagation();found=event.getTargetRanges()[0]}let found=null;view.contentDOM.addEventListener("beforeinput",read,!0);view.dom.ownerDocument.execCommand("indent");view.contentDOM.removeEventListener("beforeinput",read,!0);if(!found)return null;let anchorNode=found.startContainer,anchorOffset=found.startOffset,focusNode=found.endContainer,focusOffset=found.endOffset;view=view.docView.domAtPos(view.state.selection.main.anchor);isEquivalentPosition(view.node,view.offset,focusNode,
focusOffset)&&([anchorNode,anchorOffset,focusNode,focusOffset]=[focusNode,focusOffset,anchorNode,anchorOffset]);return{anchorNode,anchorOffset,focusNode,focusOffset}}function attrsFromFacet(view,facet,base){for(let sources=view.state.facet(facet),i=sources.length-1;0<=i;i--)facet=sources[i],(facet="function"==typeof facet?facet(view):facet)&&combineAttrs(facet,base);return base}function modifiers(name,event,shift){event.altKey&&(name="Alt-"+name);event.ctrlKey&&(name="Ctrl-"+name);event.metaKey&&
(name="Meta-"+name);!1!==shift&&event.shiftKey&&(name="Shift-"+name);return name}function getKeymap(state){state=state.facet(keymap);let map=Keymaps.get(state);map||Keymaps.set(state,map=buildKeymap(state.reduce((a,b)=>a.concat(b),[])));return map}function buildKeymap(bindings,platform=currentPlatform){let bound=Object.create(null),isPrefix=Object.create(null),checkPrefix=(name,is)=>{let current=isPrefix[name];if(null==current)isPrefix[name]=is;else if(current!=is)throw Error("Key binding "+name+
" is used both as a regular binding and as a multi-stroke prefix");},add=(scope,key,command,preventDefault)=>{var _a,_b,scopeObj=bound[scope]||(bound[scope]=Object.create(null));key=key.split(/ (?!$)/).map(k=>{k=k.split(/-(?!$)/);let result=k[k.length-1];"Space"==result&&(result=" ");let alt,ctrl,shift,meta;for(let i=0;i<k.length-1;++i){const mod=k[i];if(/^(cmd|meta|m)$/i.test(mod))meta=!0;else if(/^a(lt)?$/i.test(mod))alt=!0;else if(/^(c|ctrl|control)$/i.test(mod))ctrl=!0;else if(/^s(hift)?$/i.test(mod))shift=
!0;else if(/^mod$/i.test(mod))"mac"==platform?meta=!0:ctrl=!0;else throw Error("Unrecognized modifier name: "+mod);}alt&&(result="Alt-"+result);ctrl&&(result="Ctrl-"+result);meta&&(result="Meta-"+result);shift&&(result="Shift-"+result);return result});for(let i=1;i<key.length;i++){let prefix=key.slice(0,i).join(" ");checkPrefix(prefix,!0);scopeObj[prefix]||(scopeObj[prefix]={preventDefault:!0,run:[view=>{let ourObj=storedPrefix={view,prefix,scope};setTimeout(()=>{storedPrefix==ourObj&&(storedPrefix=
null)},4E3);return!0}]})}key=key.join(" ");checkPrefix(key,!1);scopeObj=scopeObj[key]||(scopeObj[key]={preventDefault:!1,run:(null===(_b=null===(_a=scopeObj._any)||void 0===_a?void 0:_a.run)||void 0===_b?void 0:_b.slice())||[]});command&&scopeObj.run.push(command);preventDefault&&(scopeObj.preventDefault=!0)};for(let b of bindings){bindings=b.scope?b.scope.split(" "):["editor"];if(b.any)for(let scope of bindings){var scopeObj$jscomp$0=bound[scope]||(bound[scope]=Object.create(null));scopeObj$jscomp$0._any||
(scopeObj$jscomp$0._any={preventDefault:!1,run:[]});for(let key in scopeObj$jscomp$0)scopeObj$jscomp$0[key].run.push(b.any)}if(scopeObj$jscomp$0=b[platform]||b.key)for(let scope of bindings)add(scope,scopeObj$jscomp$0,b.run,b.preventDefault),b.shift&&add(scope,"Shift-"+scopeObj$jscomp$0,b.shift,b.preventDefault)}return bound}function runHandlers(map,event,view,scope){let name=w3cKeyname.keyName(event);var charCode=state$jscomp$0.codePointAt(name,0);charCode=state$jscomp$0.codePointSize(charCode)==
name.length&&" "!=name;let prefix="",fallthrough=!1;storedPrefix&&storedPrefix.view==view&&storedPrefix.scope==scope&&(prefix=storedPrefix.prefix+" ",fallthrough=0>modifierCodes.indexOf(event.keyCode))&&(storedPrefix=null);let ran=new Set,runFor=binding=>{if(binding){for(let cmd of binding.run)if(!ran.has(cmd)&&(ran.add(cmd),cmd(view,event)))return!0;binding.preventDefault&&(fallthrough=!0)}return!1};map=map[scope];let baseName,shiftName;if(map){if(runFor(map[prefix+modifiers(name,event,!charCode)]))return!0;
if(charCode&&(event.altKey||event.metaKey||event.ctrlKey)&&(baseName=w3cKeyname.base[event.keyCode])&&baseName!=name){if(runFor(map[prefix+modifiers(baseName,event,!0)])||event.shiftKey&&(shiftName=w3cKeyname.shift[event.keyCode])!=name&&shiftName!=baseName&&runFor(map[prefix+modifiers(shiftName,event,!1)]))return!0}else if(charCode&&event.shiftKey&&runFor(map[prefix+modifiers(name,event,!0)]))return!0;if(runFor(map._any))return!0}return fallthrough}function getBase(view){let rect=view.scrollDOM.getBoundingClientRect();
...
endBlock).from-1?to$jscomp$1.push(piece(leftSide,from$jscomp$1.bottom,rightSide,range.top)):from$jscomp$1.bottom<range.top&&view.elementAtHeight((from$jscomp$1.bottom+range.top)/2).type==exports.BlockType.Text&&(from$jscomp$1.bottom=range.top=(from$jscomp$1.bottom+range.top)/2);return pieces(from$jscomp$1).concat(to$jscomp$1).concat(pieces(range))}function layer$jscomp$0(config){return[ViewPlugin.define(v=>new LayerView(v,config)),layerOrder.of(config)]}function configChanged(update){return update.startState.facet(selectionConfig)!=
update.startState.facet(selectionConfig)}function iterMatches(doc,re,from,to,f){re.lastIndex=0;for(let cursor=doc.iterRange(from,to),pos=from,m;!cursor.next().done;pos+=cursor.value.length)if(!cursor.lineBreak)for(;m=re.exec(cursor.value);)f(pos+m.index,m)}function matchRanges(view,maxLength){let visible=view.visibleRanges;if(1==visible.length&&visible[0].from==view.viewport.from&&visible[0].to==view.viewport.to)return visible;let result=[];for(let {from,to}of visible)from=Math.max(view.state.doc.lineAt(from).from,
from-maxLength),to=Math.min(view.state.doc.lineAt(to).to,to+maxLength),result.length&&result[result.length-1].to>=from?result[result.length-1].to=to:result.push({from,to});return result}function specialCharPlugin(){return _plugin||(_plugin=ViewPlugin.fromClass(class{constructor(view){this.view=view;this.decorations=Decoration.none;this.decorationCache=Object.create(null);this.decorator=this.makeDecorator(view.state.facet(specialCharConfig));this.decorations=this.decorator.createDeco(view)}makeDecorator(conf){return new MatchDecorator({regexp:conf.specialChars,
decoration:(m,view,pos)=>{var {doc}=view.state;m=state$jscomp$0.codePointAt(m[0],0);return 9==m?(doc=doc.lineAt(pos),view=view.state.tabSize,pos=state$jscomp$0.countColumn(doc.text,view,pos-doc.from),Decoration.replace({widget:new TabWidget((view-pos%view)*this.view.defaultCharacterWidth)})):this.decorationCache[m]||(this.decorationCache[m]=Decoration.replace({widget:new SpecialCharWidget(conf,m)}))},boundary:conf.replaceTabs?void 0:/[^]/})}update(update){let conf=update.state.facet(specialCharConfig);
update.startState.facet(specialCharConfig)!=conf?(this.decorator=this.makeDecorator(conf),this.decorations=this.decorator.createDeco(update.view)):this.decorations=this.decorator.updateDeco(update,this.decorations)}},{decorations:v=>v.decorations}))}function getPos(view,event){var offset=view.posAtCoords({x:event.clientX,y:event.clientY},!1);let line=view.state.doc.lineAt(offset),off=offset-line.from;2E3<off?view=-1:off==line.length?(event=event.clientX,view=(offset=view.coordsAtPos(view.viewport.from))?
Math.round(Math.abs((offset.left-event)/view.defaultCharacterWidth)):-1):view=state$jscomp$0.countColumn(line.text,view.state.tabSize,offset-line.from);return{line:line.number,col:view,off}}function rectangleSelectionStyle(view,event$jscomp$0){let start$jscomp$0=getPos(view,event$jscomp$0),startSel=view.state.selection;return start$jscomp$0?{update(update){if(update.docChanged){var newStart=update.changes.mapPos(update.startState.doc.line(start$jscomp$0.line).from);newStart=update.state.doc.lineAt(newStart);
start$jscomp$0={line:newStart.number,col:start$jscomp$0.col,off:Math.min(start$jscomp$0.off,newStart.length)};startSel=startSel.map(update.changes)}},get(event,_extend,multiple){var cur=getPos(view,event);if(!cur)return startSel;event=view.state;var a=start$jscomp$0,startLine=Math.min(a.line,cur.line);_extend=Math.max(a.line,cur.line);let ranges=[];if(2E3<a.off||2E3<cur.off||0>a.col||0>cur.col){var startOff=Math.min(a.off,cur.off);for(cur=Math.max(a.off,cur.off);startLine<=_extend;startLine++)a=event.doc.line(startLine),
a.length<=cur&&ranges.push(state$jscomp$0.EditorSelection.range(a.from+startOff,a.to+cur))}else for(startOff=Math.min(a.col,cur.col),cur=Math.max(a.col,cur.col);startLine<=_extend;startLine++){a=event.doc.line(startLine);let start=state$jscomp$0.findColumn(a.text,startOff,event.tabSize,!0);if(0>start)ranges.push(state$jscomp$0.EditorSelection.cursor(a.to));else{let end=state$jscomp$0.findColumn(a.text,cur,event.tabSize);ranges.push(state$jscomp$0.EditorSelection.range(a.from+start,a.from+end))}}return ranges.length?
multiple?state$jscomp$0.EditorSelection.create(ranges.concat(startSel.ranges)):state$jscomp$0.EditorSelection.create(ranges):startSel}}:null}function windowSpace(view){({win:view}=view);return{top:0,left:0,bottom:view.innerHeight,right:view.innerWidth}}function isInTooltip(elt){for(;elt;elt=elt.parentNode)if(1==elt.nodeType&&elt.classList.contains("cm-tooltip"))return!0;return!1}function rm(node){let next=node.nextSibling;node.remove();return next}function gutters(config){let result=[gutterView];
config&&!1===config.fixed&&result.push(unfixGutters.of(!0));return result}function asArray(val){return Array.isArray(val)?val:[val]}function advanceCursor(cursor,collect,pos){for(;cursor.value&&cursor.from<=pos;)cursor.from==pos&&collect.push(cursor.value),cursor.next()}function formatNumber(view,number){return view.state.facet(lineNumberConfig).formatNumber(number,view.state)}function maxLineNumber(lines){let last=9;for(;last<lines;)last=10*last+9;return last}function matcher(decorator){return ViewPlugin.define(view=>
({decorations:decorator.createDeco(view),update(u){this.decorations=decorator.updateDeco(u,this.decorations)}}),{decorations:v=>v.decorations})}Object.defineProperty(exports,"__esModule",{value:!0});var state$jscomp$0=require("module$node_modules$$codemirror$state$dist$index_cjs"),styleMod=require("module$node_modules$style_mod$dist$style_mod_cjs"),w3cKeyname=require("module$node_modules$w3c_keyname$index_cjs");const Rect0={left:0,right:0,top:0,bottom:0};class DOMSelectionState{constructor(){this.anchorNode=
null;this.anchorOffset=0;this.focusNode=null;this.focusOffset=0}eq(domSel){return this.anchorNode==domSel.anchorNode&&this.anchorOffset==domSel.anchorOffset&&this.focusNode==domSel.focusNode&&this.focusOffset==domSel.focusOffset}setRange(range){this.set(range.anchorNode,range.anchorOffset,range.focusNode,range.focusOffset)}set(anchorNode,anchorOffset,focusNode,focusOffset){this.anchorNode=anchorNode;this.anchorOffset=anchorOffset;this.focusNode=focusNode;this.focusOffset=focusOffset}}let preventScrollSupported=
null,scratchRange;class DOMPos{constructor(node,offset,precise=!0){this.node=node;this.offset=offset;this.precise=precise}static before(dom,precise){return new DOMPos(dom.parentNode,domIndex(dom),precise)}static after(dom,precise){return new DOMPos(dom.parentNode,domIndex(dom)+1,precise)}}const noChildren=[];class ContentView{constructor(){this.dom=this.parent=null;this.dirty=2}get editorView(){if(!this.parent)throw Error("Accessing view in orphan content view");return this.parent.editorView}get overrideDOMText(){return null}get posAtStart(){return this.parent?
this.parent.posBefore(this):0}get posAtEnd(){return this.posAtStart+this.length}posBefore(view){let pos=this.posAtStart;for(let child of this.children){if(child==view)return pos;pos+=child.length+child.breakAfter}throw new RangeError("Invalid child in posBefore");}posAfter(view){return this.posBefore(view)+view.length}coordsAt(_pos,_side){return null}sync(track){if(this.dirty&2){var parent=this.dom;let prev=null,next;for(let child of this.children){if(child.dirty){if(!child.dom&&(next=prev?prev.nextSibling:
...
parent&&(track.written=!0);for(;next;)next=rm$1(next)}else if(this.dirty&1)for(parent of this.children)parent.dirty&&(parent.sync(track),parent.dirty=0)}reuseDOM(_dom){}localPosFromDOM(node,offset){if(node==this.dom)node=this.dom.childNodes[offset];else{for(offset=0==maxOffset(node)?0:0==offset?-1:1;;){let parent=node.parentNode;if(parent==this.dom)break;0==offset&&parent.firstChild!=parent.lastChild&&(offset=node==parent.firstChild?-1:1);node=parent}node=0>offset?node:node.nextSibling}if(node==this.dom.firstChild)return 0;
for(;node&&!ContentView.get(node);)node=node.nextSibling;if(!node)return this.length;for(let i=0,pos=0;;i++){offset=this.children[i];if(offset.dom==node)return pos;pos+=offset.length+offset.breakAfter}}domBoundsAround(from,to,offset=0){let fromI=-1,fromStart=-1,toI=-1,toEnd=-1;for(let i=0,pos=offset,prevEnd=offset;i<this.children.length;i++){let child=this.children[i],end=pos+child.length;if(pos<from&&end>to)return child.domBoundsAround(from,to,pos);end>=from&&-1==fromI&&(fromI=i,fromStart=pos);if(pos>
to&&child.dom.parentNode==this.dom){toI=i;toEnd=prevEnd;break}prevEnd=end;pos=end+child.breakAfter}return{from:fromStart,to:0>toEnd?offset+this.length:toEnd,startDOM:(fromI?this.children[fromI-1].dom.nextSibling:null)||this.dom.firstChild,endDOM:toI<this.children.length&&0<=toI?this.children[toI].dom:null}}markDirty(andParent=!1){this.dirty|=2;this.markParentsDirty(andParent)}markParentsDirty(childList){for(let parent=this.parent;parent;parent=parent.parent){childList&&(parent.dirty|=2);if(parent.dirty&
1)break;parent.dirty|=1;childList=!1}}setParent(parent){this.parent!=parent&&(this.parent=parent,this.dirty&&this.markParentsDirty(!0))}setDOM(dom){this.dom&&(this.dom.cmView=null);this.dom=dom;dom.cmView=this}get rootView(){for(let v=this;;){let parent=v.parent;if(!parent)return v;v=parent}}replaceChildren(from,to,children=noChildren){this.markDirty();for(let i=from;i<to;i++){let child=this.children[i];child.parent==this&&child.destroy()}this.children.splice(from,to-from,...children);for(from=0;from<
...
to,source,hasStart,openStart,openEnd){return!1}become(other){return!1}canReuseDOM(other){return other.constructor==this.constructor}getSide(){return 0}destroy(){this.parent=null}}ContentView.prototype.breakAfter=0;class ChildCursor{constructor(children,pos,i){this.children=children;this.pos=pos;this.i=i;this.off=0}findPos(pos,bias=1){for(;;){if(pos>this.pos||pos==this.pos&&(0<bias||0==this.i||this.children[this.i-1].breakAfter))return this.off=pos-this.pos,this;let next=this.children[--this.i];this.pos-=
next.length+next.breakAfter}}}let nav="undefined"!=typeof navigator?navigator:{userAgent:"",vendor:"",platform:""},doc$jscomp$0="undefined"!=typeof document?document:{documentElement:{style:{}}};const ie_edge=/Edge\/(\d+)/.exec(nav.userAgent),ie_upto10=/MSIE \d/.test(nav.userAgent),ie_11up=/Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(nav.userAgent),ie=!!(ie_upto10||ie_11up||ie_edge),gecko=!ie&&/gecko\/(\d+)/i.test(nav.userAgent),chrome=!ie&&/Chrome\/(\d+)/.exec(nav.userAgent),webkit="webkitFontSmoothing"in
doc$jscomp$0.documentElement.style,safari=!ie&&/Apple Computer/.test(nav.vendor),ios=safari&&(/Mobile\/\w+/.test(nav.userAgent)||2<nav.maxTouchPoints);var browser={mac:ios||/Mac/.test(nav.platform),windows:/Win/.test(nav.platform),linux:/Linux|X11/.test(nav.platform),ie,ie_version:ie_upto10?doc$jscomp$0.documentMode||6:ie_11up?+ie_11up[1]:ie_edge?+ie_edge[1]:0,gecko,gecko_version:gecko?+(/Firefox\/(\d+)/.exec(nav.userAgent)||[0,0])[1]:0,chrome:!!chrome,chrome_version:chrome?+chrome[1]:0,ios,android:/Android\b/.test(nav.userAgent),
webkit,safari,webkit_version:webkit?+(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent)||[0,0])[1]:0,tabSize:null!=doc$jscomp$0.documentElement.style.tabSize?"tab-size":"-moz-tab-size"};class TextView extends ContentView{constructor(text){super();this.text=text}get length(){return this.text.length}createDOM(textDOM){this.setDOM(textDOM||document.createTextNode(this.text))}sync(track){this.dom||this.createDOM();this.dom.nodeValue!=this.text&&(track&&track.node==this.dom&&(track.written=!0),this.dom.nodeValue=
this.text)}reuseDOM(dom){3==dom.nodeType&&this.createDOM(dom)}merge(from,to,source){if(source&&(!(source instanceof TextView)||256<this.length-(to-from)+source.length))return!1;this.text=this.text.slice(0,from)+(source?source.text:"")+this.text.slice(to);this.markDirty();return!0}split(from){let result=new TextView(this.text.slice(from));this.text=this.text.slice(0,from);this.markDirty();return result}localPosFromDOM(node,offset){return node==this.dom?offset:offset?this.text.length:0}domAtPos(pos){return new DOMPos(this.dom,
pos)}domBoundsAround(_from,_to,offset){return{from:offset,to:offset+this.length,startDOM:this.dom,endDOM:this.dom.nextSibling}}coordsAt(pos,side){return textCoords(this.dom,pos,side)}}class MarkView extends ContentView{constructor(mark,children=[],length=0){super();this.mark=mark;this.children=children;this.length=length;for(let ch of children)ch.setParent(this)}setAttrs(dom){clearAttributes(dom);this.mark.class&&(dom.className=this.mark.class);if(this.mark.attrs)for(let name in this.mark.attrs)dom.setAttribute(name,
this.mark.attrs[name]);return dom}reuseDOM(node){node.nodeName==this.mark.tagName.toUpperCase()&&(this.setDOM(node),this.dirty|=6)}sync(track){this.dom?this.dirty&4&&this.setAttrs(this.dom):this.setDOM(this.setAttrs(document.createElement(this.mark.tagName)));super.sync(track)}merge(from,to,source,_hasStart,openStart,openEnd){if(source&&(!(source instanceof MarkView&&source.mark.eq(this.mark))||from&&0>=openStart||to<this.length&&0>=openEnd))return!1;mergeChildrenInto(this,from,to,source?source.children:
[],openStart-1,openEnd-1);this.markDirty();return!0}split(from){let result=[];var off=0;let detachFrom=-1,i=0;for(let elt of this.children){let end=off+elt.length;end>from&&result.push(off<from?elt.split(from-off):elt);0>detachFrom&&off>=from&&(detachFrom=i);off=end;i++}off=this.length-from;this.length=from;-1<detachFrom&&(this.children.length=detachFrom,this.markDirty());return new MarkView(this.mark,result,off)}domAtPos(pos){return inlineDOMAtPos(this,pos)}coordsAt(pos,side){return coordsInChildren(this,
pos,side)}}class WidgetView extends ContentView{constructor(widget,length,side){super();this.widget=widget;this.length=length;this.side=side;this.prevWidget=null}static create(widget,length,side){return new (widget.customView||WidgetView)(widget,length,side)}split(from){let result=WidgetView.create(this.widget,this.length-from,this.side);this.length-=from;return result}sync(){this.dom&&this.widget.updateDOM(this.dom)||(this.dom&&this.prevWidget&&this.prevWidget.destroy(this.dom),this.prevWidget=null,
...
r.head>r.anchor?-1:1);for(let piece of RectangleMarker.forRange(view,prim,cursor))cursors.push(piece)}}return cursors},update(update,dom){update.transactions.some(tr=>tr.scrollIntoView)&&(dom.style.animationName="cm-blink"==dom.style.animationName?"cm-blink2":"cm-blink");let confChange=configChanged(update);confChange&&(dom.style.animationDuration=update.state.facet(selectionConfig).cursorBlinkRate+"ms");return update.docChanged||update.selectionSet||confChange},mount(dom,view){dom.style.animationDuration=
...
lineNumberMarkers;exports.lineNumbers=function(config={}){return[lineNumberConfig.of(config),gutters(),lineNumberGutter]};exports.logException=logException;exports.panels=function(config){return config?[panelConfig.of(config)]:[]};exports.placeholder=function(content){return ViewPlugin.fromClass(class{constructor(view){this.view=view;this.placeholder=Decoration.set([Decoration.widget({widget:new Placeholder(content),side:1}).range(0)])}get decorations(){return this.view.state.doc.length?Decoration.none:
this.placeholder}},{decorations:v=>v.decorations})};exports.rectangularSelection=function(options){let filter=(null===options||void 0===options?void 0:options.eventFilter)||(e=>e.altKey&&0==e.button);return EditorView.mouseSelectionStyle.of((view,event)=>filter(event)?rectangleSelectionStyle(view,event):null)};exports.repositionTooltips=function(view){var _a;null===(_a=view.plugin(tooltipPlugin))||void 0===_a?void 0:_a.maybeMeasure()};exports.runScopeHandlers=function(view,event,scope){return runHandlers(getKeymap(view.state),
event,view,scope)};exports.scrollPastEnd=function(){return[plugin,contentAttributes.of(view=>{var _a;return(null===(_a=view.plugin(plugin))||void 0===_a?void 0:_a.attrs)||null})]};exports.showPanel=showPanel;exports.showTooltip=showTooltip;exports.tooltips=function(config={}){return tooltipConfig.of(config)}}
