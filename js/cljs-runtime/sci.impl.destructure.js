...
var G__56085 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__56086 = n;
var G__56087 = cljs.core.nnext(bs);
var G__56088 = true;
ret = G__56085;
n = G__56086;
bs = G__56087;
seen_rest_QMARK_ = G__56088;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__55972_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__55972_SHARP_);
}
})(),cljs.core.name(p1__55972_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__55973_SHARP_){
...
return cljs.core.namespace(p1__55973_SHARP_);
}
})(),cljs.core.name(p1__55973_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__55974_SHARP_,p2__55975_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__55974_SHARP_,p2__55975_SHARP_,(function (){var fexpr__56070 = cljs.core.val(entry);
return (fexpr__56070.cljs$core$IFn$_invoke$arity$1 ? fexpr__56070.cljs$core$IFn$_invoke$arity$1(p2__55975_SHARP_) : fexpr__56070.call(null,p2__55975_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__56071 = cljs.core.key(entry);
return (fexpr__56071.cljs$core$IFn$_invoke$arity$1 ? fexpr__56071.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__56071.call(null,bes));
})());
...
var G__56100 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__56101 = cljs.core.next(bes);
ret = G__56100;
bes = G__56101;
continue;
} else {
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__55977_SHARP_){
return (cljs.core.first(p1__55977_SHARP_) instanceof cljs.core.Keyword);
}),bents));
