...
var len__5769__auto___42046 = arguments.length;
var i__5770__auto___42047 = (0);
while(true){
if((i__5770__auto___42047 < len__5769__auto___42046)){
args__5775__auto__.push((arguments[i__5770__auto___42047]));

var G__42051 = (i__5770__auto___42047 + (1));
i__5770__auto___42047 = G__42051;
continue;
} else {
}
break;
...
var G__41991 = cljs.core.first(seq41989__$1);
var seq41989__$2 = cljs.core.next(seq41989__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41990,G__41991,seq41989__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42005_SHARP_){
return (!((cljs.core.meta(p1__42005_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42020__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42021){var _e__40311__auto__ = e42021;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e42023){var _e__40311__auto__ = e42023;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42028 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42029 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42029);

try{var map__42030 = opts;
var map__42030__$1 = cljs.core.__destructure_map(map__42030);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42030__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42028);
}});
...
var temp__5802__auto___42118 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___42118)){
var managed_print_level_42119 = temp__5802__auto___42118;
var _STAR_print_level_STAR__orig_val__42036_42120 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42037_42121 = managed_print_level_42119;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42037_42121);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42032_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42032_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42036_42120);
}} else {
job_fn();
}
