...
nextjournal.clojure_mode.extensions.match_brackets.state = module$node_modules$$codemirror$state$dist$index_cjs.StateField.define(({"create":cljs.core.constantly(module$node_modules$$codemirror$view$dist$index_cjs.Decoration.none),"update":(function (deco,p__66728){
var map__66733 = p__66728;
...
var tr = map__66733__$1;
var state = (function (){var obj66752 = map__66733__$1;
if((!((obj66752 == null)))){
return (obj66752["state"]);
} else {
return undefined;
}
})();
var docChanged = (function (){var obj66755 = map__66733__$1;
if((!((obj66755 == null)))){
return (obj66755["docChanged"]);
} else {
return undefined;
}
})();
var selection = (function (){var obj66760 = map__66733__$1;
if((!((obj66760 == null)))){
return (obj66760["selection"]);
} else {
return undefined;
}
})();
...
var decos = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (out,p__66763){
var map__66766 = p__66763;
...
var head = (function (){var obj66778 = map__66766__$1;
if((!((obj66778 == null)))){
return (obj66778["head"]);
} else {
return undefined;
}
})();
var empty = (function (){var obj66782 = map__66766__$1;
if((!((obj66782 == null)))){
return (obj66782["empty"]);
} else {
return undefined;
}
})();
...
var G__66806 = tr.state.doc.slice(head,(head + (1))).toString();
var fexpr__66805 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [")",null,"]",null,"}",null], null), null);
return (fexpr__66805.cljs$core$IFn$_invoke$arity$1 ? fexpr__66805.cljs$core$IFn$_invoke$arity$1(G__66806) : fexpr__66805.call(null,G__66806));
} else {
return and__4251__auto__;
}
})();
