...
var i_54638 = (0);
while(true){
if((i_54638 < arr.length)){
(arr[i_54638] = null);

var G__54639 = (i_54638 + (1));
i_54638 = G__54639;
continue;
} else {
}
...
var i_54646 = (self__.level + (1));
while(true){
if((i_54646 <= (new_level + (1)))){
(update[i_54646] = self__.header);

var G__54647 = (i_54646 + (1));
i_54646 = G__54647;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_54648 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_54648[i]));
} else {
x__$2.forward.push((((i < links_54648.length))?(links_54648[i]):null));
}

if((i < links_54648.length)){
(links_54648[i] = x__$2);
} else {
links_54648.push(x__$2);
}
...
var i_54650 = (0);
while(true){
if((i_54650 <= self__.level)){
var links_54651 = (update[i_54650]).forward;
if((x__$1 === (((i_54650 < links_54651.length))?(links_54651[i_54650]):null))){
(links_54651[i_54650] = (x__$1.forward[i_54650]));

var G__54655 = (i_54650 + (1));
i_54650 = G__54655;
continue;
} else {
var G__54656 = (i_54650 + (1));
i_54650 = G__54656;
continue;
}
} else {
...
var G__54658 = nx;
var G__54659 = (level__$1 - (1));
x = G__54658;
level__$1 = G__54659;
continue;
} else {
var G__54660 = x;
var G__54661 = (level__$1 - (1));
x = G__54660;
level__$1 = G__54661;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__54665 = nx;
var G__54666 = (level__$1 - (1));
x = G__54665;
level__$1 = G__54666;
continue;
} else {
var G__54667 = x;
var G__54668 = (level__$1 - (1));
x = G__54667;
level__$1 = G__54668;
continue;
}
