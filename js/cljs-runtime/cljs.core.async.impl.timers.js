...
var i_45852 = (0);
while(true){
if((i_45852 < arr.length)){
(arr[i_45852] = null);

var G__45853 = (i_45852 + (1));
i_45852 = G__45853;
continue;
} else {
}
...
var i_45863 = (self__.level + (1));
while(true){
if((i_45863 <= (new_level + (1)))){
(update[i_45863] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_45866 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45866[i]));
} else {
x__$2.forward.push((((i < links_45866.length))?(links_45866[i]):null));
}

if((i < links_45866.length)){
(links_45866[i] = x__$2);
} else {
links_45866.push(x__$2);
}
...
var i_45880 = (0);
while(true){
if((i_45880 <= self__.level)){
var links_45881 = (update[i_45880]).forward;
if((x__$1 === (((i_45880 < links_45881.length))?(links_45881[i_45880]):null))){
(links_45881[i_45880] = (x__$1.forward[i_45880]));

var G__45882 = (i_45880 + (1));
i_45880 = G__45882;
continue;
} else {
var G__45883 = (i_45880 + (1));
i_45880 = G__45883;
continue;
}
} else {
...
var G__45885 = nx;
var G__45886 = (level__$1 - (1));
x = G__45885;
level__$1 = G__45886;
continue;
} else {
var G__45887 = x;
var G__45888 = (level__$1 - (1));
x = G__45887;
level__$1 = G__45888;
continue;
}
