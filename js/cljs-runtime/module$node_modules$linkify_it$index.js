...
this;this.__tlds__=this.__tlds__.concat(list).sort().filter(function(el,idx,arr){return el!==arr[idx-1]}).reverse();compile(this);return this};LinkifyIt.prototype.normalize=function(match){match.schema||(match.url="http://"+match.url);"mailto:"!==match.schema||/^mailto:/i.test(match.url)||(match.url="mailto:"+match.url)};LinkifyIt.prototype.onCompile=function(){};module.exports=LinkifyIt}
//# sourceMappingURL=module$node_modules$linkify_it$index.js.map
