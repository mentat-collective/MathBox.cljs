...
if((c === "\n")){
var G__64410 = escape_QMARK_;
var G__64411 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__64410;
lines = G__64411;
continue;
} else {
buf.append(c);

var G__64412 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__64413 = lines;
escape_QMARK_ = G__64412;
lines = G__64413;
continue;
