...
return [(function (){var pred__63994 = cljs.core.instance_QMARK_;
var expr__63995 = reactive_val;
if(cljs.core.truth_((pred__63994.cljs$core$IFn$_invoke$arity$2 ? pred__63994.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__63995) : pred__63994.call(null,reagent.ratom.RAtom,expr__63995)))){
return "ra";
} else {
if(cljs.core.truth_((pred__63994.cljs$core$IFn$_invoke$arity$2 ? pred__63994.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__63995) : pred__63994.call(null,reagent.ratom.RCursor,expr__63995)))){
return "rc";
} else {
if(cljs.core.truth_((pred__63994.cljs$core$IFn$_invoke$arity$2 ? pred__63994.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__63995) : pred__63994.call(null,reagent.ratom.Reaction,expr__63995)))){
return "rx";
} else {
if(cljs.core.truth_((pred__63994.cljs$core$IFn$_invoke$arity$2 ? pred__63994.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__63995) : pred__63994.call(null,reagent.ratom.Track,expr__63995)))){
return "tr";
} else {
return "other";
}
...
var _STAR_in_batch_QMARK__STAR__orig_val__63997 = re_frame.interop._STAR_in_batch_QMARK__STAR_;
var _STAR_in_batch_QMARK__STAR__temp_val__63998 = true;
(re_frame.interop._STAR_in_batch_QMARK__STAR_ = _STAR_in_batch_QMARK__STAR__temp_val__63998);

try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {(re_frame.interop._STAR_in_batch_QMARK__STAR_ = _STAR_in_batch_QMARK__STAR__orig_val__63997);
}}));
});
var flush_queues_63999 = reagent.impl.batching.render_queue.flush_queues.bind(reagent.impl.batching.render_queue);
(reagent.impl.batching.render_queue.flush_queues = (function (){
return re_frame.interop.batch_updates(flush_queues_63999);
}));
var queue_render_64000 = reagent.impl.batching.queue_render;
(reagent.impl.batching.queue_render = (function (c){
if(cljs.core.truth_(re_frame.interop._STAR_in_batch_QMARK__STAR_)){
return c.forceUpdate();
} else {
return (queue_render_64000.cljs$core$IFn$_invoke$arity$1 ? queue_render_64000.cljs$core$IFn$_invoke$arity$1(c) : queue_render_64000.call(null,c));
}
}));
