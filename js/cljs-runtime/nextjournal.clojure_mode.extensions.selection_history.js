...
return cljs.core.some((function (p1__66651_SHARP_){
return cljs.core.not(p1__66651_SHARP_.empty);
}),selection.ranges);
});
/**
...
}), "update": (function (stack,p__66659){
var map__66660 = p__66659;
...
var tr = map__66660__$1;
var map__66661 = (function (){var obj66664 = map__66660__$1;
if((!((obj66664 == null)))){
return (obj66664["state"]);
} else {
return undefined;
}
})();
var map__66661__$1 = (((((!((map__66661 == null))))?(((((map__66661.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66661.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66661):map__66661);
var selection = (function (){var obj66667 = map__66661__$1;
if((!((obj66667 == null)))){
return (obj66667["selection"]);
} else {
return undefined;
}
})();
var docChanged = (function (){var obj66668 = map__66660__$1;
if((!((obj66668 == null)))){
return (obj66668["docChanged"]);
} else {
return undefined;
}
})();
...
var vec__66671 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2(previous_position,stack);
var seq__66672 = cljs.core.seq(vec__66671);
var first__66673 = cljs.core.first(seq__66672);
var seq__66672__$1 = cljs.core.next(seq__66672);
var f = first__66673;
var more = seq__66672__$1;
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__66682){
var map__66683 = p__66682;
var map__66683__$1 = (((((!((map__66683 == null))))?(((((map__66683.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66683.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66683):map__66683);
var a_start = (function (){var obj66685 = map__66683__$1;
if((!((obj66685 == null)))){
return (obj66685["from"]);
} else {
return undefined;
}
})();
var a_end = (function (){var obj66686 = map__66683__$1;
if((!((obj66686 == null)))){
return (obj66686["to"]);
} else {
return undefined;
...
return nextjournal.clojure_mode.util.update_ranges.cljs$core$IFn$_invoke$arity$3(state,({"annotations": nextjournal.clojure_mode.extensions.selection_history.event_annotation}),(function (p__66691){
...
var range = map__66693__$1;
var from = (function (){var obj66698 = map__66693__$1;
if((!((obj66698 == null)))){
return (obj66698["from"]);
} else {
return undefined;
}
})();
var to = (function (){var obj66700 = map__66693__$1;
if((!((obj66700 == null)))){
return (obj66700["to"]);
} else {
return undefined;
...
var empty = (function (){var obj66701 = map__66693__$1;
if((!((obj66701 == null)))){
return (obj66701["empty"]);
} else {
return undefined;
}
})();
if(cljs.core.truth_(empty)){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"range","range",1639692286),(function (){var or__4253__auto__ = (function (){var G__66702 = nextjournal.clojure_mode.node.nearest_touching(state,from,(-1));
if((G__66702 == null)){
return null;
} else {
return nextjournal.clojure_mode.node.balanced_range.cljs$core$IFn$_invoke$arity$2(state,G__66702);
}
})();
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"range","range",1639692286),(function (){var or__4253__auto__ = (function (){var G__66706 = nextjournal.clojure_mode.extensions.selection_history.grow_1(state,from,to);
if((G__66706 == null)){
return null;
} else {
return nextjournal.clojure_mode.node.range(G__66706);
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
