...
"y";return{measure:()=>measure(element,options.target,info$1),update:time=>{info$jscomp$0.updateScrollInfo(element,info$1,time);(options.offset||options.target)&&index.resolveOffsets(element,info$1,options)},notify:utils.isFunction(onScroll)?()=>onScroll(info$1):scrubAnimation(onScroll,info$1[axis])}}}
