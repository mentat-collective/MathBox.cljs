...
var rewrite_clj$node$protocols$Node$tag$dyn_61898 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_61898(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_61899 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_61899(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_61900 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_61900(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_61901 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_61901(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_61902 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_61902(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_61903 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_61903(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61528_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__61528_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_61906 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_61906(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_61921 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_61921(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_61922 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_61922(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_61927 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_61927(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_61945 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_61945(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_61946 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_61946(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_61947 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_61947(node);
}
});
...
var map__61753 = cljs.core.meta(node);
var map__61753__$1 = cljs.core.__destructure_map(map__61753);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61753__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61753__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61753__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61753__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__61811,p__61812){
var vec__61822 = p__61811;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61822,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61822,(1),null);
var vec__61825 = p__61812;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61825,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61825,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__61834 = col_extent;
if((row_extent === (0))){
return (G__61834 + col);
} else {
return G__61834;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__61869 = rewrite_clj.node.protocols.children(node);
var G__61869__$1 = (((G__61869 == null))?null:cljs.core.first(G__61869));
if((G__61869__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__61869__$1);
}
} else {
