...
var G__64438 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__64439 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__64438;
lines = G__64439;
continue;
} else {
...
var comma_64443 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_64444 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_64443),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__64391){
var vec__64392 = p__64391;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64392,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64392,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_64444,rewrite_clj.node.protocols.coerce(v),comma_64443);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__64398 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__64398) : f.call(null,G__64398));
})(),sq);
});
